...
// V6 exam questions — 259 questions (fill + single choice)
// Auto-generated from 菲利包装_试题审阅_V6.docx
var EXAM_QUESTIONS_V6 = [
  {"id": "v6q001", "num": 1, "type": "fill", "chapter": 1, "section": "1.1 公司定位", "textZh": "菲利包装专注于（___）及化妆品包装的 ODM/OEM 制造，拥有自有（___）和自有（___）。", "blanks": ["高端香水", "工厂", "设计团队"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q002", "num": 2, "type": "single", "chapter": 1, "section": "1.1 公司定位", "textZh": "菲利包装提供哪些产品的一站式服务？", "options": ["香水液体+瓶子", "玻璃瓶+瓶盖+喷头+盒子", "仅玻璃瓶和瓶盖", "仅喷头和盒子"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q003", "num": 3, "type": "fill", "chapter": 1, "section": "1.1 公司定位", "textZh": "菲利包装生产基地位于中国（___）省（___）市（___）镇。", "blanks": ["广东省", "东莞市", "虎门镇"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q004", "num": 4, "type": "single", "chapter": 1, "section": "1.1 公司定位", "textZh": "菲利包装生产基地在哪里？", "options": ["广州市番禺区", "深圳市宝安区", "东莞市虎门镇", "上海市松江区"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q005", "num": 5, "type": "fill", "chapter": 1, "section": "1.1 公司定位", "textZh": "菲利包装的价格定位是（___），核心优势在于（___）而非低价竞争。", "blanks": ["中高端", "设计与工艺价值"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q006", "num": 6, "type": "single", "chapter": 1, "section": "1.1 公司定位", "textZh": "以下哪类客户被菲利包装列为最高优先级（★★★）？", "options": ["仅询价的散客", "灌装工厂", "自有香水品牌（欧美/中东）", "区域代理商"], "answer": 2, "image": null, "hint": "自有品牌客户有清晰定位与新品计划，是最优质合作对象。"},
  {"id": "v6q007", "num": 7, "type": "fill", "chapter": 1, "section": "1.1 公司定位", "textZh": "菲利包装四大目标市场：（___）、（___）、（___）、（___）。", "blanks": ["欧洲", "美国", "中东", "亚洲"], "blankCount": 4, "image": null, "hint": null},
  {"id": "v6q008", "num": 8, "type": "single", "chapter": 1, "section": "1.1 公司定位", "textZh": "以下哪个不是菲利包装主要目标市场？", "options": ["欧洲", "南美洲", "中东", "亚洲"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q009", "num": 9, "type": "fill", "chapter": 2, "section": "2.1 六步流程", "textZh": "定制项目流程共（___）步，第一步是（___），第六步是（___）。", "blanks": ["6步", "设计构思（Design Concept）", "大货生产（Mass Production）"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q010", "num": 10, "type": "single", "chapter": 2, "section": "2.1 六步流程", "textZh": "以下六步流程排序正确的是？", "options": ["设计构思→3D打样→原型渲染→报价→模具→大货", "设计构思→原型渲染→3D打样→报价确认→模具与样品→大货生产", "报价→设计→打样→模具→生产→交货", "原型渲染→设计构思→报价→3D打样→生产→验货"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q011", "num": 11, "type": "fill", "chapter": 2, "section": "2.1 六步流程", "textZh": "大货生产必须在（___）完成并获得（___）后才能启动。", "blanks": ["模具与样品确认", "客户书面签字"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q012", "num": 12, "type": "single", "chapter": 2, "section": "2.1 六步流程", "textZh": "大货生产前最关键的步骤是？", "options": ["完成报价确认", "完成3D打样", "模具与样品确认并获客户书面签字", "原型渲染完成"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q013", "num": 13, "type": "fill", "chapter": 2, "section": "2.2 公模 vs 私模", "textZh": "公模现货（标准款）MOQ = （___）pcs；私模定制（开模款）MOQ = （___）pcs。", "blanks": ["10,000 pcs", "20,000–30,000 pcs"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q014", "num": 14, "type": "single", "chapter": 2, "section": "2.2 公模 vs 私模", "textZh": "私模定制最主要的特点是？", "options": ["比公模更便宜", "与其他品牌共用瓶型", "需支付开模费且MOQ更高，瓶型完全专属客户", "交期比公模短"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q015", "num": 15, "type": "fill", "chapter": 2, "section": "2.2 公模 vs 私模", "textZh": "公模的瓶型是（___）的；私模的瓶型是（___）的。", "blanks": ["与其他品牌共用标准款", "客户品牌专属"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q016", "num": 16, "type": "fill", "chapter": 3, "section": "3.1 规格与材料", "textZh": "香水瓶最常见的 FEA 颈口规格是（___）mm。", "blanks": ["15 mm"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q017", "num": 17, "type": "single", "chapter": 3, "section": "3.1 规格与材料", "textZh": "FEA 颈口规格最常用的是？", "options": ["FEA 13mm", "FEA 15mm", "FEA 18mm", "FEA 20mm"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q018", "num": 18, "type": "fill", "chapter": 3, "section": "3.1 规格与材料", "textZh": "\"高白料玻璃\" 的英文是（___）。", "blanks": ["White Opal Glass"], "blankCount": 1, "image": null, "hint": "透明度高，折射效果好"},
  {"id": "v6q019", "num": 19, "type": "fill", "chapter": 3, "section": "3.1 规格与材料", "textZh": "\"普通毛瓶\" 的英文是（___）。", "blanks": ["Flint Glass", "Plain Bottles"], "blankCount": 1, "image": null, "hint": "通用玻璃，成本较低"},
  {"id": "v6q020", "num": 20, "type": "fill", "chapter": 3, "section": "3.1 规格与材料", "textZh": "\"溢流容量\"的英文缩写是（___），全称是（___）。", "blanks": ["OFC", "Over Flow Capacity"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q021", "num": 21, "type": "single", "chapter": 3, "section": "3.1 规格与材料", "textZh": "\"OFC\"代表什么？", "options": ["Official Fill Capacity", "Over Flow Capacity", "Output Final Check", "Original Fill Code"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q022", "num": 22, "type": "fill", "chapter": 3, "section": "3.1 规格与材料", "textZh": "封口方式分为（___）和（___）两种，两者（___）互换。", "blanks": ["卡口（Crimp）", "螺口（Screw）", "不可"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q023", "num": 23, "type": "single", "chapter": 3, "section": "3.1 规格与材料", "textZh": "卡口（Crimp）和螺口（Screw）的关键区别是？", "options": ["只是尺寸不同", "可以互换使用", "结构完全不同，不可互换，必须下单前确认", "螺口比卡口便宜"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q024", "num": 24, "type": "fill", "chapter": 3, "section": "3.2 A/B 结构详解", "textZh": "A 结构香水瓶的典型配件是（___）和（___），常见于（___）风格。", "blanks": ["肩套（Shoulder）", "铝牌（Name Plate）", "中东高端"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q025", "num": 25, "type": "fill", "chapter": 3, "section": "3.2 A/B 结构详解", "textZh": "B 结构香水瓶的典型配件是（___），常见于（___）风格。", "blanks": ["中套（Collar）", "欧美现代"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q026", "num": 26, "type": "single", "chapter": 3, "section": "3.2 A/B 结构详解", "textZh": "以下哪种配件组合属于 A 结构？", "options": ["中套（Collar）+喷头", "肩套（Shoulder）+铝牌（Name Plate）", "天地盒+磁吸盖", "植绒内托+木盒"], "answer": 1, "image": null, "hint": "A结构=肩套+铝牌（中东）；B结构=中套（欧美）。"},
  {"id": "v6q027", "num": 27, "type": "single", "chapter": 3, "section": "3.2 A/B 结构详解", "textZh": "B 结构香水瓶的核心装饰配件是？", "options": ["肩套（Shoulder）", "铝牌（Name Plate）", "中套（Collar）", "木盖"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q028", "num": 28, "type": "fill", "chapter": 3, "section": "3.2 A/B 结构详解", "textZh": "A结构和B结构的结构不同会直接影响（___）和（___）。", "blanks": ["配件选型", "产品报价"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q029", "num": 29, "type": "fill", "chapter": 3, "section": "3.3 看图识别题 — A/B 结构", "textZh": "图中香水瓶瓶肩位置有一圈套件（肩套），瓶身另有金属铭牌，这是（___）结构香水瓶。", "blanks": ["A 结构（Shoulder + Name Plate 中东高端风格）"], "blankCount": 1, "image": ["image1.jpg"], "hint": "A结构特征：肩套（Shoulder）覆盖瓶肩 + 铝牌（Name Plate）展示品牌，多见于中东高端香水。"},
  {"id": "v6q030", "num": 30, "type": "fill", "chapter": 3, "section": "3.3 看图识别题 — A/B 结构", "textZh": "图中香水瓶瓶口喷头处套有一圈装饰圈，无铭牌，这是（___）结构香水瓶，核心配件叫（___）。", "blanks": ["B 结构", "中套（Collar", "Ring）"], "blankCount": 2, "image": ["image2.jpg"], "hint": "B结构特征：中套（Collar）套在喷头底部，欧美现代简约风格常见。"},
  {"id": "v6q031", "num": 31, "type": "single", "chapter": 3, "section": "3.3 看图识别题 — A/B 结构", "textZh": "图中左图和右图分别展示两款香水瓶结构，请判断：左图属于哪种结构？", "options": ["A 结构（肩套+铝牌）", "B 结构（中套）", "两者相同，都是 A 结构", "两者相同，都是 B 结构"], "answer": 1, "image": ["image2.jpg", "image1.jpg"], "hint": "左图(img_001)为B结构：瓶口有中套（Collar），无铭牌；右图(img_002)为A结构：有肩套和铭牌。"},
  {"id": "v6q032", "num": 32, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"喷涂\" 的英文是（___）。", "blanks": ["Color Coating", "Painting"], "blankCount": 1, "image": null, "hint": "可做实色/透明/渐变"},
  {"id": "v6q033", "num": 33, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"UV 电镀\" 的英文是（___）。", "blanks": ["Metalizing", "UV Plating"], "blankCount": 1, "image": null, "hint": "金属质感，金/银/玫瑰金等"},
  {"id": "v6q034", "num": 34, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"蒙沙 / 喷沙\" 的英文是（___）。", "blanks": ["Frosting", "Sand-blasting"], "blankCount": 1, "image": null, "hint": "磨砂质感，低调奢华"},
  {"id": "v6q035", "num": 35, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"植绒\" 的英文是（___）。", "blanks": ["Flocking", "Velvet"], "blankCount": 1, "image": null, "hint": "天鹅绒触感"},
  {"id": "v6q036", "num": 36, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"裂纹\" 的英文是（___）。", "blanks": ["Cracking"], "blankCount": 1, "image": null, "hint": "特殊纹理效果"},
  {"id": "v6q037", "num": 37, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"烫金\" 的英文是（___）。", "blanks": ["Hot Stamping"], "blankCount": 1, "image": null, "hint": "常用于品牌 LOGO"},
  {"id": "v6q038", "num": 38, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"丝印\" 的英文是（___）。", "blanks": ["Silk Screen", "Silk-screen Printing"], "blankCount": 1, "image": null, "hint": "网版印刷"},
  {"id": "v6q039", "num": 39, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"橡胶漆\" 的英文是（___）。", "blanks": ["Rubber Coating", "Soft Touch"], "blankCount": 1, "image": null, "hint": "哑面柔软防滑"},
  {"id": "v6q040", "num": 40, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"镭射\" 的英文是（___）。", "blanks": ["Laser Engraving", "Holographic"], "blankCount": 1, "image": null, "hint": "激光镭射效果，有深度感"},
  {"id": "v6q041", "num": 41, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"转印\" 的英文是（___）。", "blanks": ["Transfer", "Decal"], "blankCount": 1, "image": null, "hint": "图案转印到瓶身"},
  {"id": "v6q042", "num": 42, "type": "fill", "chapter": 3, "section": "3.4 玻璃瓶装饰工艺（11种）— 词汇填空", "textZh": "\"UV 打印\" 的英文是（___）。", "blanks": ["UV Printing"], "blankCount": 1, "image": null, "hint": "打印机直接打印，表面有颗粒感"},
  {"id": "v6q043", "num": 43, "type": "fill", "chapter": 3, "section": "3.5 玻璃瓶工艺特性 — 知识点题", "textZh": "\"UV 电镀（UV Plating）\"产生的视觉效果是（___）。", "blanks": ["金属光泽（金", "银", "玫瑰金等）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q044", "num": 44, "type": "single", "chapter": 3, "section": "3.5 玻璃瓶工艺特性 — 知识点题", "textZh": "以下哪种工艺产生金属光泽效果？", "options": ["植绒（Flocking）", "蒙沙（Frosting）", "UV 电镀（UV Plating）", "橡胶漆（Rubber Coating）"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q045", "num": 45, "type": "fill", "chapter": 3, "section": "3.5 玻璃瓶工艺特性 — 知识点题", "textZh": "\"植绒（Flocking）\"的触感特征是（___）。", "blanks": ["天鹅绒般柔软，高档礼品感"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q046", "num": 46, "type": "single", "chapter": 3, "section": "3.5 玻璃瓶工艺特性 — 知识点题", "textZh": "\"Frosting（蒙沙）\"的视觉质感是？", "options": ["金属光泽", "彩色渐变", "磨砂哑光，低调奢华", "镜面反射"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q047", "num": 47, "type": "fill", "chapter": 3, "section": "3.5 玻璃瓶工艺特性 — 知识点题", "textZh": "\"橡胶漆（Rubber Coating）\"的手感和外观特点是（___）。", "blanks": ["哑光柔软，防滑，阻尼感强"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q048", "num": 48, "type": "single", "chapter": 3, "section": "3.5 玻璃瓶工艺特性 — 知识点题", "textZh": "哪种工艺最适合\"永不褪色\"的 Logo 刻制？", "options": ["丝印（Silk Screen）", "热转印（Transfer）", "激光雕刻（Laser Engraving）", "橡胶漆"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q049", "num": 49, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身呈均匀透明蓝色，可透过玻璃看到内部，这属于（___）工艺。", "blanks": ["透喷（Transparent Color Coating）"], "blankCount": 1, "image": ["image3.jpg"], "hint": "透喷工艺保留玻璃透明感，瓶身颜色均匀透明；与实喷（不透明）和渐变喷涂（透→有色过渡）不同。"},
  {"id": "v6q050", "num": 50, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身颜色均匀饱满，完全不透明，这属于（___）工艺。", "blanks": ["实喷（Solid Color Coating", "Painting）"], "blankCount": 1, "image": ["image4.jpg"], "hint": "实喷使瓶身颜色完全不透明；透喷保留透明感；渐变喷涂则是从透明到有色自然过渡。"},
  {"id": "v6q051", "num": 51, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身呈现高度反光的金属镜面质感，此工艺最可能是？", "options": ["蒙沙（Frosting）", "植绒（Flocking）", "UV 电镀（UV Plating）", "橡胶漆（Rubber Coating）"], "answer": 2, "image": ["image5.jpg"], "hint": "UV电镀（UV Plating / Metalizing）产生金属镜面光泽，常用金/银/玫瑰金等颜色提升档次感。"},
  {"id": "v6q052", "num": 52, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身表面均匀细腻，呈磨砂哑光质感，低调奢华，此为哪种工艺？", "options": ["喷涂（Color Coating）", "UV 电镀（UV Plating）", "蒙沙（Frosting / Sand-blasting）", "植绒（Flocking）"], "answer": 2, "image": ["image6.jpg"], "hint": "蒙沙/喷沙工艺使玻璃表面产生磨砂效果，触感细腻，视觉低调奢华，欧美市场十分流行。"},
  {"id": "v6q053", "num": 53, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶表面触感类似天鹅绒，柔软温润，这是（___）工艺。", "blanks": ["植绒（Flocking", "Velvet）"], "blankCount": 1, "image": ["image7.jpg"], "hint": "植绒工艺将绒毛纤维喷附到涂有胶水的表面，产生天鹅绒触感，高档礼品感强。"},
  {"id": "v6q054", "num": 54, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身布满细密龟裂状纹路，这是哪种装饰工艺？", "options": ["蚀刻（Etching）", "镭射（Laser Engraving）", "裂纹（Cracking）", "橡胶漆（Rubber Coating）"], "answer": 2, "image": ["image8.jpg"], "hint": "裂纹工艺通过特殊漆料在干燥过程中产生龟裂纹路，视觉效果独特，艺术感强。"},
  {"id": "v6q055", "num": 55, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身的品牌 LOGO 呈金色金属箔片效果，这属于（___）工艺。", "blanks": ["烫金（Hot Stamping", "Foil Stamping）"], "blankCount": 1, "image": ["image9.jpg"], "hint": "烫金通过热压将金属箔转移到瓶身，LOGO 呈现金属光泽，常用于品牌名称、LOGO 装饰。"},
  {"id": "v6q056", "num": 56, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身图案/Logo 通过网版油墨印刷，层次清晰，此为哪种工艺？", "options": ["烫金（Hot Stamping）", "UV打印（UV Printing）", "丝印（Silk Screen）", "转印（Transfer）"], "answer": 2, "image": ["image10.jpg"], "hint": "丝印（Silk Screen）使用网版将油墨印刷到瓶身，可印刷各色油墨，适合较复杂图案。"},
  {"id": "v6q057", "num": 57, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶外表面为哑光质感，手感柔软如橡胶，防滑，这是（___）工艺。", "blanks": ["橡胶漆（Rubber Coating", "Soft Touch）"], "blankCount": 1, "image": ["image11.jpg"], "hint": "橡胶漆又称软触感漆，哑光柔软，阻尼感强，深受注重手感的客户欢迎。"},
  {"id": "v6q058", "num": 58, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶表面有类似镭射全息效果，在不同角度呈现不同光泽，此为哪种工艺？", "options": ["丝印（Silk Screen）", "镭射（Laser / Holographic）", "烫金（Hot Stamping）", "转印（Transfer）"], "answer": 1, "image": ["image12.jpg"], "hint": "镭射/全息工艺使表面产生多彩折射效果，视觉冲击力强，适合特殊系列香水。"},
  {"id": "v6q059", "num": 59, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身印有精美花纹图案，该图案是预先印刷好后整体转移到瓶身上的，这是（___）工艺。", "blanks": ["转印（Transfer", "Decal）"], "blankCount": 1, "image": ["image13.jpg"], "hint": null},
  {"id": "v6q060", "num": 60, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶表面可见由打印机直接打印的图案，表面有轻微颗粒感，这是（___）工艺。", "blanks": ["UV 打印（UV Printing", "Digital Printing）"], "blankCount": 1, "image": ["image14.jpg"], "hint": "UV打印使用紫外线固化油墨直接打印在瓶身，颜色丰富，但表面有颗粒感，批量成本较高。"},
  {"id": "v6q061", "num": 61, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "请看两张图：左图瓶身磨砂哑光，右图瓶身金属镜面光泽，请分别选出正确的工艺：", "options": ["左图=植绒，右图=喷涂", "左图=蒙沙（Frosting），右图=UV电镀（UV Plating）", "左图=橡胶漆，右图=蒙沙", "两张都是蒙沙工艺"], "answer": 1, "image": ["image6.jpg", "image5.jpg"], "hint": "磨砂哑光=蒙沙（Frosting）；金属镜面=UV电镀（UV Plating / Metalizing）。"},
  {"id": "v6q062", "num": 62, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "请看两张图：左图天鹅绒触感，右图哑光柔软防滑，请分别识别正确工艺：", "options": ["左图=蒙沙，右图=植绒", "左图=植绒（Flocking），右图=橡胶漆（Rubber Coating）", "左图=橡胶漆，右图=蒙沙", "两张都是植绒工艺"], "answer": 1, "image": ["image7.jpg", "image11.jpg"], "hint": "植绒（Flocking）触感如天鹅绒；橡胶漆（Rubber Coating）哑光防滑阻尼感。"},
  {"id": "v6q063", "num": 63, "type": "fill", "chapter": 4, "section": "4.1 材料词汇", "textZh": "\"锌铝合金盖（商品名）\" 的英文是（___）。", "blanks": ["Zamak Cap", "Zinc Alloy Cap"], "blankCount": 1, "image": null, "hint": "重量感强，中东高端市场首选"},
  {"id": "v6q064", "num": 64, "type": "fill", "chapter": 4, "section": "4.1 材料词汇", "textZh": "\"沙林盖（杜邦离子型树脂）\" 的英文是（___）。", "blanks": ["Surlyn Cap"], "blankCount": 1, "image": null, "hint": "高透明，欧美市场常用"},
  {"id": "v6q065", "num": 65, "type": "fill", "chapter": 4, "section": "4.1 材料词汇", "textZh": "\"聚丙烯盖\" 的英文是（___）。", "blanks": ["PP Cap (Polypropylene)"], "blankCount": 1, "image": null, "hint": "轻量低成本"},
  {"id": "v6q066", "num": 66, "type": "fill", "chapter": 4, "section": "4.1 材料词汇", "textZh": "\"木盖\" 的英文是（___）。", "blanks": ["Wooden Cap"], "blankCount": 1, "image": null, "hint": "自然质感，环保定位"},
  {"id": "v6q067", "num": 67, "type": "fill", "chapter": 4, "section": "4.1 材料词汇", "textZh": "\"磁吸盖\" 的英文是（___）。", "blanks": ["Magnetic Cap"], "blankCount": 1, "image": null, "hint": "开合顺滑，高级感强"},
  {"id": "v6q068", "num": 68, "type": "fill", "chapter": 4, "section": "4.1 材料词汇", "textZh": "\"K料盖\" 的英文是（___）。", "blanks": ["K Resin", "Acrylic Cap"], "blankCount": 1, "image": null, "hint": "透明感强，常见欧美时尚款"},
  {"id": "v6q069", "num": 69, "type": "fill", "chapter": 4, "section": "4.2 材料知识点", "textZh": "\"Zamak（锌合金）\"盖子的最大优势是（___）。", "blanks": ["重量感强，电镀效果出色，代表品质感"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q070", "num": 70, "type": "single", "chapter": 4, "section": "4.2 材料知识点", "textZh": "\"Zamak（锌合金）\"盖子最适合哪类市场？", "options": ["大众低价日化", "儿童香水", "中东高端香水市场", "运动香水"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q071", "num": 71, "type": "fill", "chapter": 4, "section": "4.2 材料知识点", "textZh": "\"Surlyn（沙林）\"盖子外观特点是（___）。", "blanks": ["高透明度，可做渐变色和内嵌装饰，水晶感"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q072", "num": 72, "type": "single", "chapter": 4, "section": "4.2 材料知识点", "textZh": "\"Surlyn（沙林）\"盖子最受哪类客户青睐？", "options": ["中东传统市场", "欧美时尚香水品牌", "大众超市", "儿童品牌"], "answer": 1, "image": null, "hint": "Surlyn透明感强，工艺灵活，深受欧美品牌喜爱。"},
  {"id": "v6q073", "num": 73, "type": "fill", "chapter": 4, "section": "4.2 材料知识点", "textZh": "磁吸盖常规磁力规格为（___）和（___）两种，必须在（___）阶段确认。", "blanks": ["N42", "N52", "打样阶段"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q074", "num": 74, "type": "single", "chapter": 4, "section": "4.2 材料知识点", "textZh": "磁力规格为什么必须在打样阶段确认？", "options": ["磁铁不影响产品质量", "磁力过强或过弱均影响开合体验，大货后更改成本极高", "大货时再选更灵活", "磁力规格不影响成本"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q075", "num": 75, "type": "fill", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖质感厚重，适合电镀，是中东高端香水市场首选材质，它是（___）材料盖。", "blanks": ["Zamak（锌合金", "Zinc Alloy）盖"], "blankCount": 1, "image": ["image15.jpg"], "hint": "Zamak锌合金密度大、重量感强，可做精细造型和各种电镀工艺，是代表档次感的首选材质；ABS为轻量工程塑料，无法体现厚重感。"},
  {"id": "v6q076", "num": 76, "type": "fill", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖具有高透明度，类似水晶折射效果，常用于欧美时尚香水，它最可能是（___）材料。", "blanks": ["Surlyn（沙林）或 K 料（K Resin", "Acrylic）"], "blankCount": 1, "image": ["image16.jpg"], "hint": "Surlyn和K料均有水晶般透明感，可做渐变色或内嵌装饰，深受欧美品牌青睐。"},
  {"id": "v6q077", "num": 77, "type": "fill", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖呈现木质纹理，自然质感，适合定位环保或自然风格的品牌，它是（___）盖。", "blanks": ["Wood（木盖", "Wooden Cap）"], "blankCount": 1, "image": ["image17.jpg"], "hint": null},
  {"id": "v6q078", "num": 78, "type": "single", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖开合方式特别顺滑，带磁吸闭合，高级感强，它是哪种类型的盖？", "options": ["ABS 工程塑料盖", "Zamak 锌合金盖", "Magnetic 磁吸盖", "Surlyn 沙林盖"], "answer": 2, "image": ["image18.jpg"], "hint": "磁吸盖（Magnetic Cap）内置磁铁，开合顺滑静音，高端感强，磁力规格须在打样阶段确认。"},
  {"id": "v6q079", "num": 79, "type": "single", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中香水盖表面呈现特殊的岩石裂纹纹理，粗粝质感，它是哪种类型的盖？", "options": ["木盖（Wood Cap）", "Zamak 电镀盖", "Rock 岩石纹盖", "磁吸盖（Magnetic Cap）"], "answer": 2, "image": ["image19.jpg"], "hint": "Rock岩石纹盖表面经特殊处理，呈现天然岩石质感，适合硬朗风格的香水品牌。"},
  {"id": "v6q080", "num": 80, "type": "single", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "请看两张图，左图盖子厚重有金属感，右图盖子透明有水晶感。请选出正确的材料对应：", "options": ["左图=Surlyn，右图=Zamak", "左图=Zamak（锌合金），右图=Surlyn / K 料", "左图=PP塑料，右图=木盖", "两款都是 Zamak"], "answer": 1, "image": ["image15.jpg", "image16.jpg"], "hint": "Zamak重量感强适合电镀；Surlyn/K料透明如水晶，各有其目标市场。"},
  {"id": "v6q081", "num": 81, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"喷头\" 的英文是（___）。", "blanks": ["Spray Pump", "Sprayer"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q082", "num": 82, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"导管（伸入瓶底的管）\" 的英文是（___）。", "blanks": ["Dip-tube", "Intake Tube"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q083", "num": 83, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"弹簧\" 的英文是（___）。", "blanks": ["Upper Spring", "Spring"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q084", "num": 84, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"密封圈\" 的英文是（___）。", "blanks": ["Gasket"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q085", "num": 85, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"真空泵\" 的英文是（___）。", "blanks": ["Airless Pump"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q086", "num": 86, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"喷嘴\" 的英文是（___）。", "blanks": ["Nozzle"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q087", "num": 87, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"活塞\" 的英文是（___）。", "blanks": ["Piston"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q088", "num": 88, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"卡口式喷头\" 的英文是（___）。", "blanks": ["Crimp Pump"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q089", "num": 89, "type": "fill", "chapter": 5, "section": "5.1 词汇填空", "textZh": "\"螺口式喷头\" 的英文是（___）。", "blanks": ["Screw Pump", "Screw Type"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q090", "num": 90, "type": "fill", "chapter": 5, "section": "5.2 知识点题", "textZh": "喷头最标准的颈口尺寸是（___）mm，标准出液量为（___）ml/次。", "blanks": ["15 mm", "0.10–0.12 ml", "次"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q091", "num": 91, "type": "single", "chapter": 5, "section": "5.2 知识点题", "textZh": "喷头标准出液量（Dosage）是多少？", "options": ["0.05 ml/次", "0.10–0.12 ml/次", "0.50 ml/次", "1.00 ml/次"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q092", "num": 92, "type": "fill", "chapter": 5, "section": "5.2 知识点题", "textZh": "\"导管（Dip-tube）\"在喷头中的作用是（___）。", "blanks": ["伸入瓶底，将香水从瓶底吸至喷头出口"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q093", "num": 93, "type": "single", "chapter": 5, "section": "5.2 知识点题", "textZh": "\"真空泵（Airless Pump）\"最适合哪类产品？", "options": ["大众日化香水", "高端精华或需长保质期的产品", "儿童香水", "运动喷雾"], "answer": 1, "image": null, "hint": "真空泵通过活塞完全隔绝空气，防止内容物氧化变质。"},
  {"id": "v6q094", "num": 94, "type": "fill", "chapter": 5, "section": "5.2 知识点题", "textZh": "\"螺口式（Screw Type）\"喷头的优势是（___）。", "blanks": ["可旋转锁定，防止旅行中误喷，符合航空安规"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q095", "num": 95, "type": "single", "chapter": 5, "section": "5.2 知识点题", "textZh": "哪种喷头适合旅行装？", "options": ["卡口式（Crimp Pump）", "螺口式（Screw Type）", "真空泵（Airless Pump）", "普通按压泵"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q096", "num": 96, "type": "fill", "chapter": 5, "section": "5.2 知识点题", "textZh": "卡口式（Crimp）和螺口式（Screw）喷头（___）互换，下单前必须确认。", "blanks": ["不可"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q097", "num": 97, "type": "single", "chapter": 5, "section": "5.2 知识点题", "textZh": "接到客户喷头订单，以下哪个信息最关键需首先确认？", "options": ["颜色", "是否带导管", "卡口（Crimp）还是螺口（Screw）型号", "喷嘴长短"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q098", "num": 98, "type": "fill", "chapter": 5, "section": "5.3 看图识别题 — 喷头", "textZh": "图中展示的是香水包装的核心功能零部件，负责将香水雾化喷出，标准颈口 15mm，它叫（___）。", "blanks": ["卡口式喷头（Crimp Pump", "Sprayer）"], "blankCount": 1, "image": ["image20.jpg"], "hint": "卡口式喷头用金属卡环固定在瓶口，安装后不可拆卸，是最常见的喷头类型。"},
  {"id": "v6q099", "num": 99, "type": "fill", "chapter": 5, "section": "5.3 看图识别题 — 喷头", "textZh": "图中展示的喷头底部可旋转锁定，防止旅行中误喷，符合航空安规，它是（___）喷头。", "blanks": ["螺口式喷头（Screw Pump", "Screw Type）"], "blankCount": 1, "image": ["image21.jpg"], "hint": "螺口式喷头可拧入拧出，旅行装常用，旋转锁定后防止液体泄漏。"},
  {"id": "v6q100", "num": 100, "type": "single", "chapter": 5, "section": "5.3 看图识别题 — 喷头", "textZh": "请看两张图，左图为螺口式，右图为卡口式喷头。以下哪种说法正确？", "options": ["两种喷头可以互换使用", "螺口式（左图）可旋转锁定，卡口式（右图）固定安装后不可拆卸", "卡口式（右图）更适合旅行装", "两者都适合旅行装"], "answer": 1, "image": ["image21.jpg", "image20.jpg"], "hint": "卡口（Crimp）和螺口（Screw）结构完全不同，不可互换，必须下单前与客户确认。"},
  {"id": "v6q101", "num": 101, "type": "fill", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "\"中套\" 的英文是（___）。", "blanks": ["Collar", "Ring", "Sleeve"], "blankCount": 1, "image": null, "hint": "套在喷头与瓶口之间的装饰固定圈（B结构）"},
  {"id": "v6q102", "num": 102, "type": "fill", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "\"肩套\" 的英文是（___）。", "blanks": ["Shoulder", "Shoulder Collar"], "blankCount": 1, "image": null, "hint": "套在瓶肩处的配件（A结构）"},
  {"id": "v6q103", "num": 103, "type": "fill", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "\"中套（Collar）\"的安装位置和主要作用是（___）。", "blanks": ["套在瓶口处，位于喷头与瓶身之间，起美化装饰和固定喷头的双重作用"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q104", "num": 104, "type": "single", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "\"Collar（中套）\"主要用于哪种结构的香水瓶？", "options": ["A 结构（中东风格）", "B 结构（欧美风格）", "两种都用", "只用于木盖款式"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q105", "num": 105, "type": "fill", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "\"肩套（Shoulder）\"的安装位置是（___），主要用于（___）结构的香水瓶。", "blanks": ["覆盖瓶肩（肩部）处", "A 结构"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q106", "num": 106, "type": "fill", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "中套标准金/银色 MOQ = （___）pcs；定制颜色 MOQ = （___）pcs。", "blanks": ["10,000 pcs", "30,000 pcs"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q107", "num": 107, "type": "single", "chapter": 6, "section": "6.1 词汇与基础知识", "textZh": "中套完全定制颜色的 MOQ 是多少？", "options": ["5,000 pcs", "10,000 pcs", "20,000 pcs", "30,000 pcs"], "answer": 3, "image": null, "hint": null},
  {"id": "v6q108", "num": 108, "type": "fill", "chapter": 6, "section": "6.2 看图识别题 — 中套与肩套", "textZh": "图中展示的零部件套在喷头与瓶口之间，呈金色/银色，起装饰固定作用，它叫（___），用于（___）结构香水瓶。", "blanks": ["标准中套（Standard Collar", "Ring）", "B 结构"], "blankCount": 2, "image": ["image22.jpg"], "hint": "中套是B结构香水瓶的标志性配件，欧美现代简约风格常见，标准色金/银 MOQ=10,000pcs。"},
  {"id": "v6q109", "num": 109, "type": "fill", "chapter": 6, "section": "6.2 看图识别题 — 中套与肩套", "textZh": "图中展示的配件覆盖在香水瓶的肩部位置，用于 A 结构香水瓶，它叫做（___）。", "blanks": ["定制肩套（Custom Shoulder Collar）"], "blankCount": 1, "image": ["image23.jpg"], "hint": "肩套是A结构的专属配件，覆盖瓶肩，常与铝牌（Name Plate）搭配使用，中东风格常见。"},
  {"id": "v6q110", "num": 110, "type": "single", "chapter": 6, "section": "6.2 看图识别题 — 中套与肩套", "textZh": "请看两图，左图配件覆盖瓶肩，右图配件套在瓶口喷头处。请判断：左图配件用于哪种结构？", "options": ["A 结构（肩套，中东风格）", "B 结构（中套，欧美风格）", "两种结构都可以", "只用于圆形瓶型"], "answer": 0, "image": ["image23.jpg", "image22.jpg"], "hint": "左图(img_031)=定制肩套（Shoulder）用于A结构；右图(img_032)=标准中套（Collar）用于B结构。"},
  {"id": "v6q111", "num": 111, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"铝牌 / 标牌\" 的英文是（___）。", "blanks": ["Name Plate", "Custom Plate"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q112", "num": 112, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"镜面铝\" 的英文是（___）。", "blanks": ["Mirror Aluminum"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q113", "num": 113, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"拉丝铝\" 的英文是（___）。", "blanks": ["Brushed Aluminum"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q114", "num": 114, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"压铸\" 的英文是（___）。", "blanks": ["Die Casting"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q115", "num": 115, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"抛光\" 的英文是（___）。", "blanks": ["Polishing"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q116", "num": 116, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"腐蚀（不锈钢工艺）\" 的英文是（___）。", "blanks": ["Etching"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q117", "num": 117, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"仿珐琅\" 的英文是（___）。", "blanks": ["Soft Enamel"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q118", "num": 118, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"浮雕\" 的英文是（___）。", "blanks": ["Embossing"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q119", "num": 119, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"凹雕\" 的英文是（___）。", "blanks": ["Debossing"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q120", "num": 120, "type": "fill", "chapter": 7, "section": "7.1 词汇填空", "textZh": "\"氧化（铝专用）\" 的英文是（___）。", "blanks": ["Anodized"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q121", "num": 121, "type": "fill", "chapter": 7, "section": "7.2 标牌知识点", "textZh": "香水标牌 MOQ = （___）pcs（标准金/银色）。", "blanks": ["3,000 pcs"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q122", "num": 122, "type": "single", "chapter": 7, "section": "7.2 标牌知识点", "textZh": "标牌材料中，质感最厚实、最有重量感的是？", "options": ["铝标牌（Aluminum）", "不锈钢标牌（Stainless Steel）", "锌合金标牌（Zamak）", "塑料标牌"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q123", "num": 123, "type": "fill", "chapter": 7, "section": "7.2 标牌知识点", "textZh": "\"激光雕刻（Laser Engraving）\"相比丝印（Silk Screen）的最大优势是（___）。", "blanks": ["无需油墨，永不褪色，精度极高"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q124", "num": 124, "type": "single", "chapter": 7, "section": "7.2 标牌知识点", "textZh": "哪种铝标牌工艺适合\"Logo 永不褪色\"的需求？", "options": ["丝印（Silk Screen）", "激光雕刻（Laser Engraving）", "UV打印", "电镀"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q125", "num": 125, "type": "fill", "chapter": 7, "section": "7.2 标牌知识点", "textZh": "\"仿珐琅（Soft Enamel）\"与普通\"上色（Epoxy）\"最大的区别是（___）。", "blanks": ["仿珐琅填充后经打磨，颜色与金属面齐平", "普通上色（滴胶）颜色高于金属面"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q126", "num": 126, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示的是铝标牌印刷设备，可印渐变色和4C叠加图案，叫做（___）工艺。", "blanks": ["平印（Off-set Printing）"], "blankCount": 1, "image": ["image24.jpg"], "hint": "平印可印渐变色等复杂图案，是铝标牌最常用的印刷工艺之一。"},
  {"id": "v6q127", "num": 127, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中设备将油墨直接喷涂在铝板上，墨点较大，此为哪种工艺？", "options": ["平印（Off-set Printing）", "UV 打印（Digital Printing）", "丝印（Silk Screen）", "氧化（Anodized）"], "answer": 1, "image": ["image25.jpg"], "hint": "UV打印（Digital Printing）使用打印机直接在铝板上打印，油墨较厚，墨点较大。"},
  {"id": "v6q128", "num": 128, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示丝网印刷工艺，此工艺特别适合印刷什么特殊材料？", "options": ["只适合印刷单色", "特别适合含闪粉等颗粒较大的油墨", "只能印刷白色", "只适合大面积底色"], "answer": 1, "image": ["image26.jpg"], "hint": "丝印油墨厚度介于平印和UV打印之间，针对闪粉等颗粒大的油墨，只有丝印才能完成。"},
  {"id": "v6q129", "num": 129, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中铝标牌上的 Logo 向外凸起呈 3D 立体效果，此为（___）工艺；若图案向内凹陷则为（___）工艺。", "blanks": ["凸字（Embossing", "激凸）", "凹字（Debossing", "压凹）"], "blankCount": 2, "image": ["image27.jpg"], "hint": null},
  {"id": "v6q130", "num": 130, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中铝标牌表面处理形成了有颜色的氧化层，此为哪种工艺？", "options": ["电镀（Metalizing）", "喷涂（Color Coating）", "氧化（Anodized）", "光学镀（Lighting Coating）"], "answer": 2, "image": ["image28.jpg"], "hint": "氧化（Anodized）仅适用于铝材质，通过电化学氧化形成颜色氧化层，但容易出现色差。"},
  {"id": "v6q131", "num": 131, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中不锈钢标牌表面呈现细沙底哑光效果，此为（___）工艺。", "blanks": ["腐蚀（Etching）"], "blankCount": 1, "image": ["image29.jpg"], "hint": "不锈钢腐蚀工艺形成沙底哑光效果，配合上色可做丰富层次。"},
  {"id": "v6q132", "num": 132, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示在标牌凹槽处填入彩色材料，此为哪种技术？", "options": ["电镀（Metalizing）", "腐蚀（Etching）", "上色/滴胶（Epoxy / Fill Up Colors）", "烫金（Hot Stamping）"], "answer": 2, "image": ["image30.jpg"], "hint": "滴胶/上色工艺在腐蚀后的凹槽中填入颜色，增加层次感。"},
  {"id": "v6q133", "num": 133, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示的是锌合金标牌的第一道工序：将锌合金熔液注入模具成型，此为（___）工艺。", "blanks": ["压铸（Die Casting）"], "blankCount": 1, "image": ["image31.jpg"], "hint": null},
  {"id": "v6q134", "num": 134, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中工序在压铸后进行，通过打磨去除锌合金毛坯氧化层，使表面光滑，此为？", "options": ["电镀（Metalizing）", "氧化（Anodized）", "抛光（Polishing）", "腐蚀（Etching）"], "answer": 2, "image": ["image32.jpg"], "hint": "抛光是锌合金标牌压铸后的必须步骤，为后续电镀打底。"},
  {"id": "v6q135", "num": 135, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中标牌工艺将珐琅胶填入凹槽，经打磨后颜色与金属面齐平，此为（___）工艺，区别于普通滴胶。", "blanks": ["仿珐琅（Soft Enamel）"], "blankCount": 1, "image": ["image33.jpg"], "hint": null},
  {"id": "v6q136", "num": 136, "type": "fill", "chapter": 7, "section": "7.4 看图识别题 — 标牌产品样品", "textZh": "图中展示铝标牌成品样品，它贴附在香水瓶身上展示品牌，叫做（___），英文是（___）。", "blanks": ["铝标牌（Aluminum Name Plate", "Custom Plate）"], "blankCount": 2, "image": ["image34.jpg"], "hint": null},
  {"id": "v6q137", "num": 137, "type": "fill", "chapter": 7, "section": "7.4 看图识别题 — 标牌产品样品", "textZh": "图中展示铝标牌已安装到香水瓶上的完整效果，整体风格是（___）市场常见的香水风格。", "blanks": ["中东高端（Middle East Luxury）"], "blankCount": 1, "image": ["image35.jpg"], "hint": "铝牌/金属标牌搭配A结构（肩套）是中东高端香水的标志性组合。"},
  {"id": "v6q138", "num": 138, "type": "single", "chapter": 7, "section": "7.4 看图识别题 — 标牌产品样品", "textZh": "请看两张标牌图，哪张是不锈钢标牌（Stainless Steel）、哪张是锌合金标牌（Zinc Alloy / Zamak）？", "options": ["左图=锌合金，右图=不锈钢", "左图=不锈钢（Stainless Steel），右图=锌合金（Zinc Alloy / Zamak）", "两张都是铝标牌", "两张都是锌合金标牌"], "answer": 1, "image": ["image36.jpg", "image37.jpg"], "hint": "左图(img_013)=不锈钢标牌；右图(img_012)=锌合金（Zamak）标牌，质感最厚实。"},
  {"id": "v6q139", "num": 139, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"折叠卡盒\" 的英文是（___）。", "blanks": ["Folding Box", "Soft Box"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q140", "num": 140, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"翻盖精品盒（磁吸）\" 的英文是（___）。", "blanks": ["Rigid Box – Book Shape", "Magnetic Closure"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q141", "num": 141, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"抽屉盒\" 的英文是（___）。", "blanks": ["Drawer Box", "Rigid Box – Drawer Shape"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q142", "num": 142, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"天地盒\" 的英文是（___）。", "blanks": ["Rigid Box – Top & Bottom", "Lid and Base Box"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q143", "num": 143, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"圆筒盒\" 的英文是（___）。", "blanks": ["Cylinder Box"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q144", "num": 144, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"木盒\" 的英文是（___）。", "blanks": ["Wooden Box"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q145", "num": 145, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"试香纸\" 的英文是（___）。", "blanks": ["Test Paper", "Blotter", "Scent Card"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q146", "num": 146, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"手提纸袋\" 的英文是（___）。", "blanks": ["Paper Bag", "Carrier Bag"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q147", "num": 147, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"EVA 泡棉内托\" 的英文是（___）。", "blanks": ["EVA Liner", "EVA Foam Insert"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q148", "num": 148, "type": "fill", "chapter": 8, "section": "8.1 词汇填空 — 盒型", "textZh": "\"坑纸内托\" 的英文是（___）。", "blanks": ["Corrugated Liner", "Corrugated Paper Insert"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q149", "num": 149, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"热烫 / 烫色\" 的英文是（___）。", "blanks": ["Hot Stamping", "Foil Stamping"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q150", "num": 150, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"激凸 / 压凹\" 的英文是（___）。", "blanks": ["Embossing", "Debossing"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q151", "num": 151, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"光胶（覆膜）\" 的英文是（___）。", "blanks": ["Glossy Lamination"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q152", "num": 152, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"哑胶（覆膜）\" 的英文是（___）。", "blanks": ["Matt Lamination"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q153", "num": 153, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"过 UV（局部 UV）\" 的英文是（___）。", "blanks": ["UV Coating", "UV Spot"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q154", "num": 154, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"四色印刷\" 的英文是（___）。", "blanks": ["CMYK Printing"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q155", "num": 155, "type": "fill", "chapter": 8, "section": "8.2 词汇填空 — 盒子工艺", "textZh": "\"单色印刷（潘通色号）\" 的英文是（___）。", "blanks": ["Pantone Printing"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q156", "num": 156, "type": "fill", "chapter": 8, "section": "8.3 知识点题", "textZh": "\"折叠卡盒（Folding Box）\"最大的优势是（___）。", "blanks": ["可折叠平铺，节省运输空间，成本最低，适合大批量零售产品"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q157", "num": 157, "type": "single", "chapter": 8, "section": "8.3 知识点题", "textZh": "以下哪种盒型成本最低、适合大批量零售？", "options": ["精品翻盖硬盒（Rigid Box）", "木盒（Wooden Box）", "折叠卡盒（Folding Box）", "抽屉盒（Drawer Box）"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q158", "num": 158, "type": "fill", "chapter": 8, "section": "8.3 知识点题", "textZh": "\"精品硬盒（Rigid Box）\"无法折叠的原因是（___）。", "blanks": ["内含硬质灰板（Greyboard），结构固定"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q159", "num": 159, "type": "single", "chapter": 8, "section": "8.3 知识点题", "textZh": "\"Drawer Box（抽屉盒）\"最突出的体验特点是？", "options": ["成本最低", "推拉式开合体验独特，适合礼品套装", "可折叠存放", "只适合圆形瓶型"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q160", "num": 160, "type": "fill", "chapter": 8, "section": "8.3 知识点题", "textZh": "香水外盒法规要求必须印制的五类信息：（①）、（②）、（③）、（④）、（⑤）。", "blanks": ["①品牌名 ②净含量(ml", "oz) ③INCI成分表 ④条形码(Barcode) ⑤原产地(Country of Origin)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q161", "num": 161, "type": "single", "chapter": 8, "section": "8.3 知识点题", "textZh": "哪种盒子工艺组合最常见于高端香水包装（背景哑、Logo 亮）？", "options": ["光胶+烫金", "哑胶+局部UV（Matt Lamination + UV Spot）", "CMYK+光胶", "Pantone+过UV"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q162", "num": 162, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中香水盒的开合方式类似书本翻开，通常带磁吸扣，视觉高档，此盒型叫（___）。", "blanks": ["翻盖精品盒（Rigid Box – Book Shape", "Magnetic Closure）"], "blankCount": 1, "image": ["image38.jpg"], "hint": null},
  {"id": "v6q163", "num": 163, "type": "single", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中香水盒为推拉式开合，展示感强，中东高端市场非常流行，它是？", "options": ["折叠卡盒（Folding Box）", "天地盒（Lid and Base Box）", "抽屉盒（Drawer Box）", "圆筒盒（Cylinder Box）"], "answer": 2, "image": ["image39.jpg"], "hint": null},
  {"id": "v6q164", "num": 164, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中香水盒分上下两部分，盖与底完全分离，此盒型叫（___），英文是（___）。", "blanks": ["天地盒", "Rigid Box – Top & Bottom（Lid and Base Box）"], "blankCount": 2, "image": ["image40.jpg"], "hint": null},
  {"id": "v6q165", "num": 165, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是香水礼盒，材质天然，带木纹质感，定位自然环保风格，它叫（___）。", "blanks": ["木盒（Wooden Box）"], "blankCount": 1, "image": ["image41.jpg"], "hint": null},
  {"id": "v6q166", "num": 166, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是（___）香水盒，外形为圆筒形状，英文名是（___）。", "blanks": ["圆筒盒", "Cylinder Box"], "blankCount": 2, "image": ["image42.jpg"], "hint": null},
  {"id": "v6q167", "num": 167, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的香水盒可以折叠平铺储存，成本最低，适合大批量零售，它叫（___）。", "blanks": ["折叠卡盒（Folding Box", "Soft Box）"], "blankCount": 1, "image": ["image43.jpg"], "hint": null},
  {"id": "v6q168", "num": 168, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是一种细长纸条，用于让顾客在购买前感受香水气味，它叫（___），英文是（___）。", "blanks": ["试香纸", "Blotter（Test Paper", "Scent Card）"], "blankCount": 2, "image": ["image44.jpg"], "hint": null},
  {"id": "v6q169", "num": 169, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是香水购买后配套赠送的手提袋，它叫（___），英文是（___）。", "blanks": ["纸袋（Paper Bag", "Carrier Bag）"], "blankCount": 2, "image": ["image45.jpg"], "hint": null},
  {"id": "v6q170", "num": 170, "type": "single", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "以下三款盒型，哪种盒型的开盒体验类似拉抽屉？", "options": ["最左边（翻盖盒 Book Shape）", "中间（抽屉盒 Drawer Box）", "最右边（天地盒 Top & Bottom）", "三款都有推拉体验"], "answer": 1, "image": ["image38.jpg", "image39.jpg", "image40.jpg"], "hint": "抽屉盒（Drawer Box）推拉式开合，展示感最强，礼品套装中最受欢迎。"},
  {"id": "v6q171", "num": 171, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"出厂价（买方自提）\" 的英文是（___）。", "blanks": ["EXW (Ex Works)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q172", "num": 172, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"离岸价\" 的英文是（___）。", "blanks": ["FOB (Free On Board)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q173", "num": 173, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"成本+保险+运费\" 的英文是（___）。", "blanks": ["CIF (Cost Insurance Freight)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q174", "num": 174, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"完税交货价（门到门全包）\" 的英文是（___）。", "blanks": ["DDP (Delivered Duty Paid)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q175", "num": 175, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"成本+运费（不含保险）\" 的英文是（___）。", "blanks": ["CFR (Cost and Freight)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q176", "num": 176, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"电汇\" 的英文是（___）。", "blanks": ["T", "T (Telegraphic Transfer)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q177", "num": 177, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"信用证\" 的英文是（___）。", "blanks": ["L", "C (Letter of Credit)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q178", "num": 178, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"原始设备制造（按客户设计生产）\" 的英文是（___）。", "blanks": ["OEM (Original Equipment Manufacturer)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q179", "num": 179, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"原始设计制造（供应商提供设计）\" 的英文是（___）。", "blanks": ["ODM (Original Design Manufacturer)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q180", "num": 180, "type": "fill", "chapter": 9, "section": "9.1 贸易术语词汇填空", "textZh": "\"最低起订量\" 的英文是（___）。", "blanks": ["MOQ (Minimum Order Quantity)"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q181", "num": 181, "type": "fill", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "\"FOB（离岸价）\"包含（___）、（___）和（___），不含国际运费和目的地关税。", "blanks": ["产品成本", "国内货代费", "出口港装船费"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q182", "num": 182, "type": "single", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "\"FOB\"和\"CIF\"最主要的区别是？", "options": ["CIF不含产品成本", "CIF额外包含国际运费和运输保险", "CIF更便宜", "CIF只用于空运"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q183", "num": 183, "type": "fill", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "\"DDP（完税交货价）\"是（___）全包报价，含产品、货代、（___）和（___）。", "blanks": ["门到门", "国际运费", "目的地关税及税费"], "blankCount": 3, "image": null, "hint": null},
  {"id": "v6q184", "num": 184, "type": "single", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "卖方承担所有费用到门的贸易术语是？", "options": ["EXW", "FOB", "CIF", "DDP"], "answer": 3, "image": null, "hint": null},
  {"id": "v6q185", "num": 185, "type": "single", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "买方承担所有费用（自行提货）的贸易术语是？", "options": ["EXW", "FOB", "CIF", "DDP"], "answer": 0, "image": null, "hint": null},
  {"id": "v6q186", "num": 186, "type": "fill", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "\"PayPal\"付款手续费为（___）%，报价时须将此成本计入售价。", "blanks": ["4.5 %"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q187", "num": 187, "type": "single", "chapter": 9, "section": "9.2 贸易术语知识点", "textZh": "PayPal 付款手续费是多少？", "options": ["1.5%", "2.5%", "4.5%", "6%"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q188", "num": 188, "type": "fill", "chapter": 9, "section": "9.3 MOQ 汇总", "textZh": "公模现货 MOQ = （___）pcs", "blanks": ["10,000 pcs"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q189", "num": 189, "type": "fill", "chapter": 9, "section": "9.3 MOQ 汇总", "textZh": "私模定制 MOQ = （___）pcs，需额外支付（___）。", "blanks": ["20,000–30,000 pcs", "一次性开模费"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q190", "num": 190, "type": "fill", "chapter": 9, "section": "9.3 MOQ 汇总", "textZh": "中套标准色 MOQ = （___）pcs；定制色 MOQ = （___）pcs。", "blanks": ["10,000 pcs", "30,000 pcs"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q191", "num": 191, "type": "fill", "chapter": 9, "section": "9.3 MOQ 汇总", "textZh": "标牌（Name Plate）标准色 MOQ = （___）pcs。", "blanks": ["3,000 pcs"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q192", "num": 192, "type": "single", "chapter": 9, "section": "9.3 MOQ 汇总", "textZh": "以下 MOQ 信息哪项是错误的？", "options": ["公模现货 MOQ = 10,000 pcs", "私模定制 MOQ = 20,000–30,000 pcs", "标牌标准色 MOQ = 3,000 pcs", "中套定制色 MOQ = 10,000 pcs"], "answer": 3, "image": null, "hint": "中套定制色 MOQ = 30,000 pcs（不是10,000），10,000 pcs是标准金/银色的MOQ。"},
  {"id": "v6q208", "num": 208, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "以下三张图展示三种不同效果的香水瓶，请判断：呈现金属镜面光泽的是哪张图？", "options": ["左图（透喷 Transparent Coating）", "中图（实喷 Solid Coating）", "右图（UV 电镀 / UV Plating）", "三张都有金属光泽"], "answer": 2, "image": ["image3.jpg", "image4.jpg", "image5.jpg"], "hint": "左图(img_000)=透明喷涂（透喷）；中图(img_050)=实色喷涂；右图(img_049)=UV电镀金属镜面光泽。"},
  {"id": "v6q209", "num": 209, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "图中两款香水瓶，左图为A结构，右图为B结构，以下描述正确的是？", "options": ["左图有中套（Collar），右图有肩套（Shoulder）", "左图有肩套（Shoulder）和铭牌，右图有中套（Collar）", "两款都是B结构", "两款都是A结构"], "answer": 1, "image": ["image1.jpg", "image2.jpg"], "hint": "A结构(左图img_002)=肩套+铭牌，中东风格；B结构(右图img_001)=中套，欧美风格。"},
  {"id": "v6q210", "num": 210, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "图中两张图都展示喷头，左图为螺口式，右图为卡口式，以下说法正确的是？", "options": ["两种喷头可以互换使用", "螺口式（左图）可旋转锁定适合旅行装；卡口式（右图）固定安装", "卡口式（右图）更适合旅行装", "螺口式价格更高"], "answer": 1, "image": ["image21.jpg", "image20.jpg"], "hint": null},
  {"id": "v6q211", "num": 211, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "以下四款盒型，哪款成本最低、可折叠平铺运输？", "options": ["左一（翻盖精品盒 Rigid Box）", "左二（抽屉盒 Drawer Box）", "左三（折叠卡盒 Folding Box）", "右一（木盒 Wooden Box）"], "answer": 2, "image": ["image38.jpg", "image39.jpg", "image43.jpg", "image41.jpg"], "hint": "折叠卡盒(img_006)可折叠平铺，节省运输空间，成本最低，适合大批量零售。"},
  {"id": "v6q212", "num": 212, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "以下两图：左图为标准中套（B结构），右图为定制肩套（A结构）。以下哪种说法最准确？", "options": ["左图用于A结构，右图用于B结构", "左图（标准中套）用于B结构欧美风格，右图（肩套）用于A结构中东风格", "两款配件功能相同，只是颜色不同", "两款都是中套（Collar）"], "answer": 1, "image": ["image22.jpg", "image23.jpg"], "hint": "标准中套=B结构欧美风格；定制肩套=A结构中东风格。接单必须与客户确认结构！"},
  {"id": "v6q213", "num": 213, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"蒙沙（磨砂质感）\" 的英文是（___）。", "blanks": ["Frosting", "Frosted"], "blankCount": 1, "image": null, "hint": "蒙沙对玻璃表面磨砂处理，呈低调哑光质感，欧美市场常见。"},
  {"id": "v6q214", "num": 214, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"植绒（绒布手感）\" 的英文是（___）。", "blanks": ["Flocking", "Velvet"], "blankCount": 1, "image": null, "hint": "植绒在瓶身表面黏附短绒纤维，形成天鹅绒触感，高端礼品感强。"},
  {"id": "v6q215", "num": 215, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"烫金\" 的英文是（___）。", "blanks": ["Hot Stamping", "Gold Blocking", "Foil Stamping"], "blankCount": 1, "image": null, "hint": "热压金属箔片，常用于 LOGO 印制，每种工艺标准 MOQ 10,000 pcs。"},
  {"id": "v6q216", "num": 216, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"丝印\" 的英文是（___）。", "blanks": ["Silkscreen Printing", "Silk Print"], "blankCount": 1, "image": null, "hint": "通过网版将油墨印刷在产品上，适合 LOGO 和图案精细印刷。"},
  {"id": "v6q217", "num": 217, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"电镀\" 的英文是（___）。", "blanks": ["Metalizing", "Metallization", "Galvanized Plating"], "blankCount": 1, "image": null, "hint": "水镀（Galvanized）是最常用电镀方式，可做金色/银色/黑镍等效果。"},
  {"id": "v6q218", "num": 218, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"渐变喷涂\" 的英文是（___）。", "blanks": ["Gradient Color Coating"], "blankCount": 1, "image": null, "hint": "颜色从深到浅或从一色过渡到另一色，常见于高端香水瓶设计。"},
  {"id": "v6q219", "num": 219, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"透明喷涂（透喷）\" 的英文是（___）。", "blanks": ["Transparent Color Coating"], "blankCount": 1, "image": null, "hint": "可透过涂层看到玻璃内部，区别于实色喷涂（Solid Color Coating）。"},
  {"id": "v6q220", "num": 220, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"橡胶漆\" 的英文是（___）。", "blanks": ["Rubber Coating", "Soft Touch"], "blankCount": 1, "image": null, "hint": "表面柔软防滑，哑面阻尼手感，质感高级。"},
  {"id": "v6q221", "num": 221, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"裂纹效果\" 的英文是（___）。", "blanks": ["Cracking"], "blankCount": 1, "image": null, "hint": "仿岩石开裂纹理效果，艺术感强，属特殊质感工艺。"},
  {"id": "v6q222", "num": 222, "type": "fill", "chapter": 10, "section": "一、工艺词汇 — 中译英", "textZh": "\"滴胶\" 的英文是（___）。", "blanks": ["Epoxy"], "blankCount": 1, "image": null, "hint": "将透明树脂滴入 LOGO 凹槽，固化后呈现立体亮面效果。"},
  {"id": "v6q223", "num": 223, "type": "fill", "chapter": 10, "section": "二、产品词汇 — 中译英", "textZh": "\"锌铝合金盖\" 的英文是（___）。", "blanks": ["Zamac Cap", "Zinc Alloy Cap"], "blankCount": 1, "image": null, "hint": "Zamak/Zamac 即锌铝合金，重量感好，中东高端市场常用。"},
  {"id": "v6q224", "num": 224, "type": "fill", "chapter": 10, "section": "二、产品词汇 — 中译英", "textZh": "\"沙林盖\" 的英文是（___）。", "blanks": ["Surlyn Cap"], "blankCount": 1, "image": null, "hint": "高透明，仿水晶感，常见于欧式设计，沙林是离聚物材料。"},
  {"id": "v6q225", "num": 225, "type": "fill", "chapter": 10, "section": "二、产品词汇 — 中译英", "textZh": "\"流苏\" 的英文是（___）。", "blanks": ["Tassel"], "blankCount": 1, "image": null, "hint": "常通过龙虾扣（Lobster Clasp）挂在瓶身，海关编码 3926400000。"},
  {"id": "v6q226", "num": 226, "type": "fill", "chapter": 10, "section": "二、产品词汇 — 中译英", "textZh": "\"封口机\" 的英文是（___）。", "blanks": ["Crimping Machine"], "blankCount": 1, "image": null, "hint": "用于将卡口（Crimp）喷头压接固定在瓶口，卡口款必须使用封口机。"},
  {"id": "v6q227", "num": 227, "type": "fill", "chapter": 10, "section": "二、产品词汇 — 中译英", "textZh": "\"试香纸\" 的英文是（___）。", "blanks": ["Blotter", "Perfume Scent Card"], "blankCount": 1, "image": null, "hint": "展会或门店供客户试香使用，也是产品8种包装类型之一。"},
  {"id": "v6q228", "num": 228, "type": "fill", "chapter": 10, "section": "二、产品词汇 — 中译英", "textZh": "\"卡口喷头\" 的英文是（___）。", "blanks": ["Crimp Pump"], "blankCount": 1, "image": null, "hint": "Crimp Pump 压接卡固，不可拆卸，为日常零售款最常见封口方式。"},
  {"id": "v6q229", "num": 229, "type": "fill", "chapter": 10, "section": "三、纸盒词汇 — 英译中", "textZh": "\"Rigid Box\" 的中文是（___）。", "blanks": ["手工精品盒"], "blankCount": 1, "image": null, "hint": "海关编码 4819200000，含翻盖书型（Book Shape）和抽屉盒（Drawer）等款式。"},
  {"id": "v6q230", "num": 230, "type": "fill", "chapter": 10, "section": "三、纸盒词汇 — 英译中", "textZh": "\"EVA Liner\" 的中文是（___）。", "blanks": ["EVA 内托（Ethylene Vinyl Acetate）"], "blankCount": 1, "image": null, "hint": "发泡材料，可定制切槽固定瓶身，常用于精品盒内部保护。"},
  {"id": "v6q231", "num": 231, "type": "fill", "chapter": 10, "section": "三、纸盒词汇 — 英译中", "textZh": "\"Matt Lamination\" 的中文是（___）。", "blanks": ["哑胶"], "blankCount": 1, "image": null, "hint": "纸盒哑光覆膜，质感低调；相对应的是 Glossy Lamination（光胶）。"},
  {"id": "v6q232", "num": 232, "type": "fill", "chapter": 10, "section": "三、纸盒词汇 — 英译中", "textZh": "\"Blotter\" 的中文是（___）。", "blanks": ["试香纸"], "blankCount": 1, "image": null, "hint": "不要混淆 Blotter（试香纸）与 Corrugated paper（瓦楞纸）。"},
  {"id": "v6q233", "num": 233, "type": "fill", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "公模标准款（现有瓶型）的最低起订量（MOQ）是_____ pcs。", "blanks": ["10,000 pcs"], "blankCount": 1, "image": null, "hint": "定制款 MOQ 更高，为 20,000–30,000 pcs；公模款为 10,000 pcs。"},
  {"id": "v6q234", "num": 234, "type": "fill", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "香水标牌（Custom Plate）的最低起订量是_____ pcs（标准金/银色）。", "blanks": ["3,000 pcs"], "blankCount": 1, "image": null, "hint": "标牌 MOQ 较低（3K），中套标准色 MOQ 为 10K，定制色 MOQ 为 30K。"},
  {"id": "v6q235", "num": 235, "type": "fill", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "当客户数量在 5,000–10,000 pcs 之间时，应推荐___；介绍时应称为\"_____\"而非\"库存\"。", "blanks": ["热销款（库存产品）", "\"热销品\""], "blankCount": 1, "image": null, "hint": "说\"热销品\"而非\"库存\"，能更好地体现产品价值，避免客户产生低价联想。"},
  {"id": "v6q236", "num": 236, "type": "fill", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "菲利包装的一分钟电梯话术要点：公司名称、专注_____包装超过_____年、提供_____定制服务、自有_____和_____、主要市场为欧美和中东。", "blanks": ["高端香水", "10", "ODM/OEM", "工厂", "设计团队"], "blankCount": 5, "image": null, "hint": "电梯话术必须能在 1 分钟内清晰说完，包含公司定位、核心优势、目标市场三要素。"},
  {"id": "v6q237", "num": 237, "type": "single", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "中套标准色（金/银）的 MOQ 是多少？", "options": ["3,000 pcs", "5,000 pcs", "10,000 pcs", "30,000 pcs"], "answer": 2, "image": null, "hint": "标准色中套 MOQ 10K；定制颜色中套 MOQ 30K；锌合金材质定制 MOQ 10K。"},
  {"id": "v6q238", "num": 238, "type": "single", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "每种工艺或 LOGO 颜色的 MOQ 一般是多少？", "options": ["5,000 pcs", "10,000 pcs", "20,000 pcs", "30,000 pcs"], "answer": 1, "image": null, "hint": "每种颜色/工艺各自独立计算 MOQ（10K）；老客户特殊情况可协商至 5K。"},
  {"id": "v6q239", "num": 239, "type": "single", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "\"Frosting\" 对应哪种中文工艺？", "options": ["烫金", "植绒", "蒙沙", "裂纹"], "answer": 2, "image": null, "hint": "Frosting = 蒙沙，磨砂哑光效果；Flocking = 植绒；Hot Stamping = 烫金。"},
  {"id": "v6q240", "num": 240, "type": "single", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "\"Surlyn Cap\" 的中文是什么？", "options": ["锌铝合金盖", "沙林盖", "木盖", "K料盖"], "answer": 1, "image": null, "hint": "Surlyn（沙林）是离聚物材料，高透明仿水晶感，欧式设计常见。"},
  {"id": "v6q241", "num": 241, "type": "single", "chapter": 10, "section": "四、MOQ 与业务规则", "textZh": "折叠卡盒（Folding Box）的海关编码是？", "options": ["7010909000", "3923500000", "4819200000", "9616100000"], "answer": 2, "image": null, "hint": "纸盒（精品盒/折叠盒）海关编码均为 4819200000；纸袋为 4819400000。"},
  {"id": "v6q242", "num": 242, "type": "fill", "chapter": 13, "section": "一、材料密度", "textZh": "铝（Aluminium）的密度是_____ g/cm³。", "blanks": ["2.79 g", "cm³"], "blankCount": 1, "image": null, "hint": "铝最轻，常用于铝标牌、中套、电化铝盖等；轻盈是其核心卖点。"},
  {"id": "v6q243", "num": 243, "type": "fill", "chapter": 13, "section": "一、材料密度", "textZh": "锌合金（Zamac / Zinc Alloy）的密度是_____ g/cm³。", "blanks": ["6.8 g", "cm³"], "blankCount": 1, "image": null, "hint": "锌合金密度约为铝的 2.4 倍，重量感强是其核心卖点，中东高端市场喜爱。"},
  {"id": "v6q244", "num": 244, "type": "fill", "chapter": 13, "section": "一、材料密度", "textZh": "不锈钢（Stainless Steel）的密度是_____ g/cm³。", "blanks": ["7.9 g", "cm³"], "blankCount": 1, "image": null, "hint": "不锈钢密度仅次于铜，常用于不锈钢标牌，结合腐蚀工艺质感出众。"},
  {"id": "v6q245", "num": 245, "type": "fill", "chapter": 13, "section": "二、重量计算公式", "textZh": "金属产品重量计算公式：长（mm）× 宽（mm）× _____（mm）× _____ ÷ 1000 = 重量（g）。", "blanks": ["厚度", "密度"], "blankCount": 2, "image": null, "hint": "公式：长×宽×厚×密度÷1000，单位换算：mm³ → cm³ 需除以 1000。"},
  {"id": "v6q246", "num": 246, "type": "fill", "chapter": 13, "section": "二、重量计算公式", "textZh": "铝标牌尺寸 50mm × 30mm，厚度 1.5mm，铝密度 2.79 g/cm³，计算其重量约为_____ g。", "blanks": ["6.28 g（50×30×1.5×2.79÷1000≈6.28）"], "blankCount": 1, "image": null, "hint": "计算步骤：50×30=1500，×1.5=2250，×2.79=6277.5，÷1000≈6.28g。"},
  {"id": "v6q247", "num": 247, "type": "single", "chapter": 13, "section": "二、重量计算公式", "textZh": "常规铝标牌的厚度规格是？", "options": ["0.1 mm", "0.3 mm", "1.0 mm", "1.5 mm"], "answer": 1, "image": null, "hint": "常规铝标牌厚 0.3mm；需要 3D 凸字/凹字效果的用 0.4–0.5mm；锌合金标牌厚 1.5–3mm。"},
  {"id": "v6q248", "num": 248, "type": "single", "chapter": 13, "section": "二、重量计算公式", "textZh": "锌合金标牌常规厚度范围是？", "options": ["0.3–0.5 mm", "0.5–1.0 mm", "1.5–3 mm", "3–5 mm"], "answer": 2, "image": null, "hint": "锌合金标牌厚 1.5–3mm，厚实感强；铝标牌常规 0.3mm，最薄最轻。"},
  {"id": "v6q249", "num": 249, "type": "fill", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "公司接受的 4 种付款方式是：_____、_____、_____、_____。", "blanks": ["TT（电汇）、PayPal、WU（西联汇款）、L", "C（信用证）"], "blankCount": 4, "image": null, "hint": "TT 是最常用方式；PayPal 需注意手续费；WU 适合小额；L/C 需提前协商条件。"},
  {"id": "v6q250", "num": 250, "type": "fill", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "通过 PayPal 收款时，需要在报价中额外考虑_____% 的手续费。", "blanks": ["4.5%"], "blankCount": 1, "image": null, "hint": "PayPal 手续费为 4.5%，报价时必须将此费用计入，否则会亏损。"},
  {"id": "v6q251", "num": 251, "type": "fill", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "西联汇款（Western Union）适合_____ 美金以下的小额付款，手续费由_____承担。", "blanks": ["2,000", "客户"], "blankCount": 2, "image": null, "hint": "WU 在欧洲市场常见，只需提供收款人名称，小额付款快速便捷。"},
  {"id": "v6q252", "num": 252, "type": "fill", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "订单金额小于 $10,000 时，订金比例为_____；金额 ≥ $10,000 时，订金比例为_____。", "blanks": ["50%", "30%"], "blankCount": 2, "image": null, "hint": "尾款必须在出货前结清，无特殊约定不得先出货后收款。"},
  {"id": "v6q253", "num": 253, "type": "single", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "以下哪种付款方式的手续费由卖方（我们）承担？", "options": ["TT（电汇）", "Western Union（西联）", "PayPal", "L/C（信用证）"], "answer": 2, "image": null, "hint": "PayPal 手续费 4.5% 由收款方（我们）承担，需在报价中加入；WU 手续费由付款方（客户）承担。"},
  {"id": "v6q254", "num": 254, "type": "single", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "信用证（L/C）的正确英文全称是？", "options": ["Line of Credit", "Letter of Confirmation", "Letter of Credit", "Local Credit"], "answer": 2, "image": null, "hint": "L/C = Letter of Credit（信用证），是银行为买方担保付款的贸易融资工具。"},
  {"id": "v6q255", "num": 255, "type": "single", "chapter": 14, "section": "一、付款方式（附录F）", "textZh": "以下说法正确的是？", "options": ["大单（≥$10,000）订金为 50%，小单为 30%", "小单（<$10,000）订金为 50%，大单为 30%", "所有订单统一 30% 订金", "信用证客户不需要预付订金"], "answer": 1, "image": null, "hint": "小单（<$10K）→ 50% 订金；大单（≥$10K）→ 30% 订金，尾款出货前结清。"},
  {"id": "v6q256", "num": 256, "type": "fill", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "EXW（出厂价）的含义是：_____，客户自行安排提货，不含任何_____。", "blanks": ["货物做完后的出厂价格", "运费和税费"], "blankCount": 2, "image": null, "hint": "EXW 是最基础的报价方式，卖方只负责将货物备好，其余均由买方负责。"},
  {"id": "v6q257", "num": 257, "type": "fill", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "FOB（离岸价）在 EXW 基础上额外包含：_____，约合人民币_____左右。", "blanks": ["国内货代费、报关费、内陆运输费等（装船前所有费用）", "2,000 元"], "blankCount": 2, "image": null, "hint": "FOB = 产品 + 出口港装船前产生的国内费用，是最常用的国际贸易报价方式之一。"},
  {"id": "v6q258", "num": 258, "type": "fill", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "CIF（到岸价）= FOB + _____ + _____。", "blanks": ["国际运费（海运或空运）", "保险费"], "blankCount": 2, "image": null, "hint": "CIF 是 Cost, Insurance & Freight 的缩写，具体运费需按货量向货代询价。"},
  {"id": "v6q259", "num": 259, "type": "fill", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "DDP（门到门价）包含所有费用，其中包括目的地的_____及当地_____。", "blanks": ["关税", "税费"], "blankCount": 2, "image": null, "hint": "DDP = Delivered Duty Paid，是最全包的报价方式，客户无需承担任何额外费用。"},
  {"id": "v6q260", "num": 260, "type": "single", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "客户询问 CIF 报价时，以下哪项说法正确？", "options": ["CIF 不含保险费", "CIF = 产品价格，不含运费", "CIF = FOB + 运费 + 保险", "CIF 和 DDP 完全相同"], "answer": 2, "image": null, "hint": "CIF = Cost（产品）+ Insurance（保险）+ Freight（运费），客户到港后还需自行处理清关和关税。"},
  {"id": "v6q261", "num": 261, "type": "single", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "哪种报价方式对买方最省事（全包含关税）？", "options": ["EXW", "FOB", "CIF", "DDP"], "answer": 3, "image": null, "hint": "DDP（门到门价）对买方最省事，卖方承担所有费用直至送到客户指定地点，包括目的地关税。"},
  {"id": "v6q262", "num": 262, "type": "single", "chapter": 14, "section": "二、报价价格类型（附录G）", "textZh": "以下报价方式从\"卖方责任最小\"到\"卖方责任最大\"排序正确的是？", "options": ["EXW → FOB → CIF → DDP", "FOB → EXW → DDP → CIF", "DDP → CIF → FOB → EXW", "CIF → FOB → EXW → DDP"], "answer": 0, "image": null, "hint": "EXW 卖方责任最小（仅出厂），DDP 卖方责任最大（送到目的地含关税），依次为 EXW→FOB→CIF→DDP。"},
  {"id": "v6q263", "num": 263, "type": "fill", "chapter": 15, "section": "一、流程基础知识", "textZh": "客户成单标准流程共_____个步骤，从客户_____开始，到_____结束。", "blanks": ["12", "询盘（Inquire）", "订单完成归档（Done）"], "blankCount": 3, "image": null, "hint": "12步完整闭环：询盘→报价→确认PI→收定金→生产→完工→询货代→订舱→入仓→开船→提单→归档。"},
  {"id": "v6q264", "num": 264, "type": "fill", "chapter": 15, "section": "一、流程基础知识", "textZh": "流程第 3 步\"确认订单\"时，需向客户出具_____（简称 PI）或商业发票（CI）。", "blanks": ["形式合同（Proforma Invoice）"], "blankCount": 1, "image": null, "hint": "PI = Proforma Invoice（形式合同），是正式开始执行订单的书面依据。"},
  {"id": "v6q265", "num": 265, "type": "fill", "chapter": 15, "section": "一、流程基础知识", "textZh": "流程第 4 步\"客户付定金\"后，才能进入第 5 步_____ 阶段；收到定金前不得_____。", "blanks": ["下单生产（Produce）", "提前安排生产"], "blankCount": 2, "image": null, "hint": "收定金是启动生产的前提条件，这是公司财务风险控制的底线。"},
  {"id": "v6q266", "num": 266, "type": "fill", "chapter": 15, "section": "一、流程基础知识", "textZh": "流程第 7 步\"询问货代\"需要确认的信息包括：_____、是否有指定货代、以及快递需提前确认_____。", "blanks": ["运输方式（海运/空运/快递/国内交货）", "客户的国际快递账号"], "blankCount": 2, "image": null, "hint": "快递账号需提前拿到，否则无法安排出货，会影响交期。"},
  {"id": "v6q267", "num": 267, "type": "fill", "chapter": 15, "section": "一、流程基础知识", "textZh": "流程第 11 步领取提单（B/L）后，如果客户尚未付清尾款，应_____；若已约定电放提单，则_____。", "blanks": ["凭正本提单控货，通知客户付尾款后再放单", "发邮件给客户确认电放"], "blankCount": 2, "image": null, "hint": "正本提单是控制货物的关键凭证，未收尾款前切勿放弃对提单的控制。"},
  {"id": "v6q268", "num": 268, "type": "single", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "正本提单（Original B/L）的核心作用是？", "options": ["证明货物已装船出发", "控制货物放行权，未付尾款前不可放单", "向客户收取尾款的收据", "货代订舱的凭证"], "answer": 1, "image": null, "hint": "正本提单控货：持单方才有权提货，未收尾款前不可放单，除非约定了电放（Telex Release）。"},
  {"id": "v6q269", "num": 269, "type": "single", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "出口到沙特阿拉伯，除常规单证外，还必须提供什么特殊证件？", "options": ["CE认证", "CO证书（产地证），且外箱必须标注 MADE IN CHINA", "ISO证书", "SGS检测报告"], "answer": 1, "image": null, "hint": "沙特要求：① CO（Certificate of Origin 产地证）② 外箱 MADE IN CHINA 字样，缺一会被拒绝清关。"},
  {"id": "v6q270", "num": 270, "type": "single", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "出口到欧洲时，必须使用的托盘规格是？", "options": ["60 × 100 cm", "80 × 120 cm", "100 × 120 cm", "100 × 140 cm"], "answer": 1, "image": null, "hint": "欧洲标准托盘为 80×120cm，与中国标准不同，错误规格会导致清关和仓库问题。"},
  {"id": "v6q271", "num": 271, "type": "single", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "货量约 8 个托盘但不足一个 20 尺柜时，推荐哪种运输方式？", "options": ["散货（LCL）更经济，推荐散货", "建议走整柜（FCL），目的港散货清关费用极高", "空运更划算", "先问客户预算再决定"], "answer": 1, "image": null, "hint": "约 8 个托盘推荐整柜（FCL）：目的港 LCL 散货清关费用极高，整柜综合成本更低。"},
  {"id": "v6q272", "num": 272, "type": "single", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "流程的哪个步骤中需要联系货代订舱并向报关公司提供单证资料？", "options": ["第 6 步 — 产品完成", "第 7 步 — 询问货代", "第 8 步 — 订舱报关", "第 9 步 — 入仓交货"], "answer": 2, "image": null, "hint": "第 8 步订舱报关：联系货代订舱、填订舱单，同时通知报关公司制作报关资料。"},
  {"id": "v6q273", "num": 273, "type": "single", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "下列哪个选项正确描述了\"电放提单（Telex Release）\"？", "options": ["通过电报发送实体提单", "卖方电话通知货代放货，不需要提单", "无需寄送正本提单，货代在目的港凭电放指示放货，卖方以邮件通知客户", "电子发票替代提单"], "answer": 2, "image": null, "hint": "电放（Telex Release）：卖方指示货代在目的港直接放货，客户无需提交正本提单；卖方发邮件确认即可。"},
  {"id": "v6q274", "num": 274, "type": "fill", "chapter": 15, "section": "二、关键规则与注意事项", "textZh": "订单完成的最后一步（第12步）包括：确认_____，并将订单_____。", "blanks": ["客户收货", "归档"], "blankCount": 2, "image": null, "hint": "订单归档便于日后查询、售后处理和项目复盘，是良好订单管理的必要环节。"},
];