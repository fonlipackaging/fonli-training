...
var EXAM_QUESTIONS_V6 = [
  ...
  {"id": "v6q029", "num": 29, "type": "fill", "chapter": 3, "section": "3.3 看图识别题 — A/B 结构", "textZh": "图中香水瓶瓶肩位置有一圈套件（肩套），瓶身另有金属铭牌，这是（___）结构香水瓶。", "blanks": ["A 结构（Shoulder + Name Plate 中东高端风格）"], "blankCount": 1, "image": null, "hint": "A结构特征：肩套（Shoulder）覆盖瓶肩 + 铝牌（Name Plate）展示品牌，多见于中东高端香水。"},
  {"id": "v6q030", "num": 30, "type": "fill", "chapter": 3, "section": "3.3 看图识别题 — A/B 结构", "textZh": "图中香水瓶瓶口喷头处套有一圈装饰圈，无铭牌，这是（___）结构香水瓶，核心配件叫（___）。", "blanks": ["B 结构", "中套（Collar", "Ring）"], "blankCount": 2, "image": null, "hint": "B结构特征：中套（Collar）套在喷头底部，欧美现代简约风格常见。"},
  {"id": "v6q031", "num": 31, "type": "single", "chapter": 3, "section": "3.3 看图识别题 — A/B 结构", "textZh": "图中左图和右图分别展示两款香水瓶结构，请判断：左图属于哪种结构？", "options": ["A 结构（肩套+铝牌）", "B 结构（中套）", "两者相同，都是 A 结构", "两者相同，都是 B 结构"], "answer": 1, "image": ["img_001.jpg", "img_002.jpg"], "hint": "左图(img_001)为B结构：瓶口有中套（Collar），无铭牌；右图(img_002)为A结构：有肩套和铭牌。"},
  ...
  {"id": "v6q049", "num": 49, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身呈均匀透明蓝色，可透过玻璃看到内部，这属于（___）工艺。", "blanks": ["透喷（Transparent Color Coating）"], "blankCount": 1, "image": ["img_000.jpg"], "hint": "透喷工艺保留玻璃透明感，瓶身颜色均匀透明；与实喷（不透明）和渐变喷涂（透→有色过渡）不同。"},
  {"id": "v6q050", "num": 50, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身颜色均匀饱满，完全不透明，这属于（___）工艺。", "blanks": ["实喷（Solid Color Coating", "Painting）"], "blankCount": 1, "image": ["img_050.jpg"], "hint": "实喷使瓶身颜色完全不透明；透喷保留透明感；渐变喷涂则是从透明到有色自然过渡。"},
  {"id": "v6q051", "num": 51, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身呈现高度反光的金属镜面质感，此工艺最可能是？", "options": ["蒙沙（Frosting）", "植绒（Flocking）", "UV 电镀（UV Plating）", "橡胶漆（Rubber Coating）"], "answer": 2, "image": ["img_049.jpg"], "hint": "UV电镀（UV Plating / Metalizing）产生金属镜面光泽，常用金/银/玫瑰金等颜色提升档次感。"},
  {"id": "v6q052", "num": 52, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身表面均匀细腻，呈磨砂哑光质感，低调奢华，此为哪种工艺？", "options": ["喷涂（Color Coating）", "UV 电镀（UV Plating）", "蒙沙（Frosting / Sand-blasting）", "植绒（Flocking）"], "answer": 2, "image": null, "hint": "蒙沙/喷沙工艺使玻璃表面产生磨砂效果，触感细腻，视觉低调奢华，欧美市场十分流行。"},
  {"id": "v6q053", "num": 53, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶表面触感类似天鹅绒，柔软温润，这是（___）工艺。", "blanks": ["植绒（Flocking", "Velvet）"], "blankCount": 1, "image": null, "hint": "植绒工艺将绒毛纤维喷附到涂有胶水的表面，产生天鹅绒触感，高档礼品感强。"},
  {"id": "v6q054", "num": 54, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身布满细密龟裂状纹路，这是哪种装饰工艺？", "options": ["蚀刻（Etching）", "镭射（Laser Engraving）", "裂纹（Cracking）", "橡胶漆（Rubber Coating）"], "answer": 2, "image": null, "hint": "裂纹工艺通过特殊漆料在干燥过程中产生龟裂纹路，视觉效果独特，艺术感强。"},
  {"id": "v6q055", "num": 55, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身的品牌 LOGO 呈金色金属箔片效果，这属于（___）工艺。", "blanks": ["烫金（Hot Stamping", "Foil Stamping）"], "blankCount": 1, "image": null, "hint": "烫金通过热压将金属箔转移到瓶身，LOGO 呈现金属光泽，常用于品牌名称、LOGO 装饰。"},
  {"id": "v6q056", "num": 56, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身图案/Logo 通过网版油墨印刷，层次清晰，此为哪种工艺？", "options": ["烫金（Hot Stamping）", "UV打印（UV Printing）", "丝印（Silk Screen）", "转印（Transfer）"], "answer": 2, "image": null, "hint": "丝印（Silk Screen）使用网版将油墨印刷到瓶身，可印刷各色油墨，适合较复杂图案。"},
  {"id": "v6q057", "num": 57, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶外表面为哑光质感，手感柔软如橡胶，防滑，这是（___）工艺。", "blanks": ["橡胶漆（Rubber Coating", "Soft Touch）"], "blankCount": 1, "image": null, "hint": "橡胶漆又称软触感漆，哑光柔软，阻尼感强，深受注重手感的客户欢迎。"},
  {"id": "v6q058", "num": 58, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶表面有类似镭射全息效果，在不同角度呈现不同光泽，此为哪种工艺？", "options": ["丝印（Silk Screen）", "镭射（Laser / Holographic）", "烫金（Hot Stamping）", "转印（Transfer）"], "answer": 1, "image": null, "hint": "镭射/全息工艺使表面产生多彩折射效果，视觉冲击力强，适合特殊系列香水。"},
  {"id": "v6q059", "num": 59, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶瓶身印有精美花纹图案，该图案是预先印刷好后整体转移到瓶身上的，这是（___）工艺。", "blanks": ["转印（Transfer", "Decal）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q060", "num": 60, "type": "fill", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "图中香水瓶表面可见由打印机直接打印的图案，表面有轻微颗粒感，这是（___）工艺。", "blanks": ["UV 打印（UV Printing", "Digital Printing）"], "blankCount": 1, "image": null, "hint": "UV打印使用紫外线固化油墨直接打印在瓶身，颜色丰富，但表面有颗粒感，批量成本较高。"},
  {"id": "v6q061", "num": 61, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "请看两张图：左图瓶身磨砂哑光，右图瓶身金属镜面光泽，请分别选出正确的工艺：", "options": ["左图=植绒，右图=喷涂", "左图=蒙沙（Frosting），右图=UV电镀（UV Plating）", "左图=橡胶漆，右图=蒙沙", "两张都是蒙沙工艺"], "answer": 1, "image": null, "hint": "磨砂哑光=蒙沙（Frosting）；金属镜面=UV电镀（UV Plating / Metalizing）。"},
  {"id": "v6q062", "num": 62, "type": "single", "chapter": 3, "section": "3.6 看图识别题 — 玻璃瓶工艺效果", "textZh": "请看两张图：左图天鹅绒触感，右图哑光柔软防滑，请分别识别正确工艺：", "options": ["左图=蒙沙，右图=植绒", "左图=植绒（Flocking），右图=橡胶漆（Rubber Coating）", "左图=橡胶漆，右图=蒙沙", "两张都是植绒工艺"], "answer": 1, "image": null, "hint": "植绒（Flocking）触感如天鹅绒；橡胶漆（Rubber Coating）哑光防滑阻尼感。"},
  ...
  {"id": "v6q075", "num": 75, "type": "fill", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖质感厚重，适合电镀，是中东高端香水市场首选材质，它是（___）材料盖。", "blanks": ["Zamak（锌合金", "Zinc Alloy）盖"], "blankCount": 1, "image": null, "hint": "Zamak锌合金密度大、重量感强，可做精细造型和各种电镀工艺，是代表档次感的首选材质；ABS为轻量工程塑料，无法体现厚重感。"},
  {"id": "v6q076", "num": 76, "type": "fill", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖具有高透明度，类似水晶折射效果，常用于欧美时尚香水，它最可能是（___）材料。", "blanks": ["Surlyn（沙林）或 K 料（K Resin", "Acrylic）"], "blankCount": 1, "image": null, "hint": "Surlyn和K料均有水晶般透明感，可做渐变色或内嵌装饰，深受欧美品牌青睐。"},
  {"id": "v6q077", "num": 77, "type": "fill", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖呈现木质纹理，自然质感，适合定位环保或自然风格的品牌，它是（___）盖。", "blanks": ["Wood（木盖", "Wooden Cap）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q078", "num": 78, "type": "single", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中展示的香水盖开合方式特别顺滑，带磁吸闭合，高级感强，它是哪种类型的盖？", "options": ["ABS 工程塑料盖", "Zamak 锌合金盖", "Magnetic 磁吸盖", "Surlyn 沙林盖"], "answer": 2, "image": null, "hint": "磁吸盖（Magnetic Cap）内置磁铁，开合顺滑静音，高端感强，磁力规格须在打样阶段确认。"},
  {"id": "v6q079", "num": 79, "type": "single", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "图中香水盖表面呈现特殊的岩石裂纹纹理，粗粝质感，它是哪种类型的盖？", "options": ["木盖（Wood Cap）", "Zamak 电镀盖", "Rock 岩石纹盖", "磁吸盖（Magnetic Cap）"], "answer": 2, "image": null, "hint": "Rock岩石纹盖表面经特殊处理，呈现天然岩石质感，适合硬朗风格的香水品牌。"},
  {"id": "v6q080", "num": 80, "type": "single", "chapter": 4, "section": "4.3 看图识别题 — 香水盖产品", "textZh": "请看两张图，左图盖子厚重有金属感，右图盖子透明有水晶感。请选出正确的材料对应：", "options": ["左图=Surlyn，右图=Zamak", "左图=Zamak（锌合金），右图=Surlyn / K 料", "左图=PP塑料，右图=木盖", "两款都是 Zamak"], "answer": 1, "image": null, "hint": "Zamak重量感强适合电镀；Surlyn/K料透明如水晶，各有其目标市场。"},
  ...
  {"id": "v6q098", "num": 98, "type": "fill", "chapter": 5, "section": "5.3 看图识别题 — 喷头", "textZh": "图中展示的是香水包装的核心功能零部件，负责将香水雾化喷出，标准颈口 15mm，它叫（___）。", "blanks": ["卡口式喷头（Crimp Pump", "Sprayer）"], "blankCount": 1, "image": null, "hint": "卡口式喷头用金属卡环固定在瓶口，安装后不可拆卸，是最常见的喷头类型。"},
  {"id": "v6q099", "num": 99, "type": "fill", "chapter": 5, "section": "5.3 看图识别题 — 喷头", "textZh": "图中展示的喷头底部可旋转锁定，防止旅行中误喷，符合航空安规，它是（___）喷头。", "blanks": ["螺口式喷头（Screw Pump", "Screw Type）"], "blankCount": 1, "image": null, "hint": "螺口式喷头可拧入拧出，旅行装常用，旋转锁定后防止液体泄漏。"},
  {"id": "v6q100", "num": 100, "type": "single", "chapter": 5, "section": "5.3 看图识别题 — 喷头", "textZh": "请看两张图，左图为螺口式，右图为卡口式喷头。以下哪种说法正确？", "options": ["两种喷头可以互换使用", "螺口式（左图）可旋转锁定，卡口式（右图）固定安装后不可拆卸", "卡口式（右图）更适合旅行装", "两者都适合旅行装"], "answer": 1, "image": null, "hint": "卡口（Crimp）和螺口（Screw）结构完全不同，不可互换，必须下单前与客户确认。"},
  ...
  {"id": "v6q108", "num": 108, "type": "fill", "chapter": 6, "section": "6.2 看图识别题 — 中套与肩套", "textZh": "图中展示的零部件套在喷头与瓶口之间，呈金色/银色，起装饰固定作用，它叫（___），用于（___）结构香水瓶。", "blanks": ["标准中套（Standard Collar", "Ring）", "B 结构"], "blankCount": 2, "image": null, "hint": "中套是B结构香水瓶的标志性配件，欧美现代简约风格常见，标准色金/银 MOQ=10,000pcs。"},
  {"id": "v6q109", "num": 109, "type": "fill", "chapter": 6, "section": "6.2 看图识别题 — 中套与肩套", "textZh": "图中展示的配件覆盖在香水瓶的肩部位置，用于 A 结构香水瓶，它叫做（___）。", "blanks": ["定制肩套（Custom Shoulder Collar）"], "blankCount": 1, "image": null, "hint": "肩套是A结构的专属配件，覆盖瓶肩，常与铝牌（Name Plate）搭配使用，中东风格常见。"},
  {"id": "v6q110", "num": 110, "type": "single", "chapter": 6, "section": "6.2 看图识别题 — 中套与肩套", "textZh": "请看两图，左图配件覆盖瓶肩，右图配件套在瓶口喷头处。请判断：左图配件用于哪种结构？", "options": ["A 结构（肩套，中东风格）", "B 结构（中套，欧美风格）", "两种结构都可以", "只用于圆形瓶型"], "answer": 0, "image": ["img_031.jpg", "img_032.jpg"], "hint": "左图(img_031)=定制肩套（Shoulder）用于A结构；右图(img_032)=标准中套（Collar）用于B结构。"},
  ...
  {"id": "v6q126", "num": 126, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示的是铝标牌印刷设备，可印渐变色和4C叠加图案，叫做（___）工艺。", "blanks": ["平印（Off-set Printing）"], "blankCount": 1, "image": null, "hint": "平印可印渐变色等复杂图案，是铝标牌最常用的印刷工艺之一。"},
  {"id": "v6q127", "num": 127, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中设备将油墨直接喷涂在铝板上，墨点较大，此为哪种工艺？", "options": ["平印（Off-set Printing）", "UV 打印（Digital Printing）", "丝印（Silk Screen）", "氧化（Anodized）"], "answer": 1, "image": null, "hint": "UV打印（Digital Printing）使用打印机直接在铝板上打印，油墨较厚，墨点较大。"},
  {"id": "v6q128", "num": 128, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示丝网印刷工艺，此工艺特别适合印刷什么特殊材料？", "options": ["只适合印刷单色", "特别适合含闪粉等颗粒较大的油墨", "只能印刷白色", "只适合大面积底色"], "answer": 1, "image": null, "hint": "丝印油墨厚度介于平印和UV打印之间，针对闪粉等颗粒大的油墨，只有丝印才能完成。"},
  {"id": "v6q129", "num": 129, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中铝标牌上的 Logo 向外凸起呈 3D 立体效果，此为（___）工艺；若图案向内凹陷则为（___）工艺。", "blanks": ["凸字（Embossing", "激凸）", "凹字（Debossing", "压凹）"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q130", "num": 130, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中铝标牌表面处理形成了有颜色的氧化层，此为哪种工艺？", "options": ["电镀（Metalizing）", "喷涂（Color Coating）", "氧化（Anodized）", "光学镀（Lighting Coating）"], "answer": 2, "image": null, "hint": "氧化（Anodized）仅适用于铝材质，通过电化学氧化形成颜色氧化层，但容易出现色差。"},
  {"id": "v6q131", "num": 131, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中不锈钢标牌表面呈现细沙底哑光效果，此为（___）工艺。", "blanks": ["腐蚀（Etching）"], "blankCount": 1, "image": null, "hint": "不锈钢腐蚀工艺形成沙底哑光效果，配合上色可做丰富层次。"},
  {"id": "v6q132", "num": 132, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示在标牌凹槽处填入彩色材料，此为哪种技术？", "options": ["电镀（Metalizing）", "腐蚀（Etching）", "上色/滴胶（Epoxy / Fill Up Colors）", "烫金（Hot Stamping）"], "answer": 2, "image": null, "hint": "滴胶/上色工艺在腐蚀后的凹槽中填入颜色，增加层次感。"},
  {"id": "v6q133", "num": 133, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中展示的是锌合金标牌的第一道工序：将锌合金熔液注入模具成型，此为（___）工艺。", "blanks": ["压铸（Die Casting）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q134", "num": 134, "type": "single", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中工序在压铸后进行，通过打磨去除锌合金毛坯氧化层，使表面光滑，此为？", "options": ["电镀（Metalizing）", "氧化（Anodized）", "抛光（Polishing）", "腐蚀（Etching）"], "answer": 2, "image": null, "hint": "抛光是锌合金标牌压铸后的必须步骤，为后续电镀打底。"},
  {"id": "v6q135", "num": 135, "type": "fill", "chapter": 7, "section": "7.3 看图识别题 — 标牌工艺", "textZh": "图中标牌工艺将珐琅胶填入凹槽，经打磨后颜色与金属面齐平，此为（___）工艺，区别于普通滴胶。", "blanks": ["仿珐琅（Soft Enamel）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q136", "num": 136, "type": "fill", "chapter": 7, "section": "7.4 看图识别题 — 标牌产品样品", "textZh": "图中展示铝标牌成品样品，它贴附在香水瓶身上展示品牌，叫做（___），英文是（___）。", "blanks": ["铝标牌（Aluminum Name Plate", "Custom Plate）"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q137", "num": 137, "type": "fill", "chapter": 7, "section": "7.4 看图识别题 — 标牌产品样品", "textZh": "图中展示铝标牌已安装到香水瓶上的完整效果，整体风格是（___）市场常见的香水风格。", "blanks": ["中东高端（Middle East Luxury）"], "blankCount": 1, "image": null, "hint": "铝牌/金属标牌搭配A结构（肩套）是中东高端香水的标志性组合。"},
  {"id": "v6q138", "num": 138, "type": "single", "chapter": 7, "section": "7.4 看图识别题 — 标牌产品样品", "textZh": "请看两张标牌图，哪张是不锈钢标牌（Stainless Steel）、哪张是锌合金标牌（Zinc Alloy / Zamak）？", "options": ["左图=锌合金，右图=不锈钢", "左图=不锈钢（Stainless Steel），右图=锌合金（Zinc Alloy / Zamak）", "两张都是铝标牌", "两张都是锌合金标牌"], "answer": 1, "image": ["img_013.jpg", "img_012.jpg"], "hint": "左图(img_013)=不锈钢标牌；右图(img_012)=锌合金（Zamak）标牌，质感最厚实。"},
  ...
  {"id": "v6q162", "num": 162, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中香水盒的开合方式类似书本翻开，通常带磁吸扣，视觉高档，此盒型叫（___）。", "blanks": ["翻盖精品盒（Rigid Box – Book Shape", "Magnetic Closure）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q163", "num": 163, "type": "single", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中香水盒为推拉式开合，展示感强，中东高端市场非常流行，它是？", "options": ["折叠卡盒（Folding Box）", "天地盒（Lid and Base Box）", "抽屉盒（Drawer Box）", "圆筒盒（Cylinder Box）"], "answer": 2, "image": null, "hint": null},
  {"id": "v6q164", "num": 164, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中香水盒分上下两部分，盖与底完全分离，此盒型叫（___），英文是（___）。", "blanks": ["天地盒", "Rigid Box – Top & Bottom（Lid and Base Box）"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q165", "num": 165, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是香水礼盒，材质天然，带木纹质感，定位自然环保风格，它叫（___）。", "blanks": ["木盒（Wooden Box）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q166", "num": 166, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是（___）香水盒，外形为圆筒形状，英文名是（___）。", "blanks": ["圆筒盒", "Cylinder Box"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q167", "num": 167, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的香水盒可以折叠平铺储存，成本最低，适合大批量零售，它叫（___）。", "blanks": ["折叠卡盒（Folding Box", "Soft Box）"], "blankCount": 1, "image": null, "hint": null},
  {"id": "v6q168", "num": 168, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是一种细长纸条，用于让顾客在购买前感受香水气味，它叫（___），英文是（___）。", "blanks": ["试香纸", "Blotter（Test Paper", "Scent Card）"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q169", "num": 169, "type": "fill", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "图中展示的是香水购买后配套赠送的手提袋，它叫（___），英文是（___）。", "blanks": ["纸袋（Paper Bag", "Carrier Bag）"], "blankCount": 2, "image": null, "hint": null},
  {"id": "v6q170", "num": 170, "type": "single", "chapter": 8, "section": "8.4 看图识别题 — 香水盒与配件", "textZh": "以下三款盒型，哪种盒型的开盒体验类似拉抽屉？", "options": ["最左边（翻盖盒 Book Shape）", "中间（抽屉盒 Drawer Box）", "最右边（天地盒 Top & Bottom）", "三款都有推拉体验"], "answer": 1, "image": null, "hint": "抽屉盒（Drawer Box）推拉式开合，展示感最强，礼品套装中最受欢迎。"},
  ...
  {"id": "v6q208", "num": 208, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "以下三张图展示三种不同效果的香水瓶，请判断：呈现金属镜面光泽的是哪张图？", "options": ["左图（透喷 Transparent Coating）", "中图（实喷 Solid Coating）", "右图（UV 电镀 / UV Plating）", "三张都有金属光泽"], "answer": 2, "image": ["img_000.jpg", "img_050.jpg", "img_049.jpg"], "hint": "左图(img_000)=透明喷涂（透喷）；中图(img_050)=实色喷涂；右图(img_049)=UV电镀金属镜面光泽。"},
  {"id": "v6q209", "num": 209, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "图中两款香水瓶，左图为A结构，右图为B结构，以下描述正确的是？", "options": ["左图有中套（Collar），右图有肩套（Shoulder）", "左图有肩套（Shoulder）和铭牌，右图有中套（Collar）", "两款都是B结构", "两款都是A结构"], "answer": 1, "image": ["img_002.jpg", "img_001.jpg"], "hint": "A结构(左图img_002)=肩套+铭牌，中东风格；B结构(右图img_001)=中套，欧美风格。"},
  {"id": "v6q210", "num": 210, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "图中两张图都展示喷头，左图为螺口式，右图为卡口式，以下说法正确的是？", "options": ["两种喷头可以互换使用", "螺口式（左图）可旋转锁定适合旅行装；卡口式（右图）固定安装", "卡口式（右图）更适合旅行装", "螺口式价格更高"], "answer": 1, "image": null, "hint": null},
  {"id": "v6q211", "num": 211, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "以下四款盒型，哪款成本最低、可折叠平铺运输？", "options": ["左一（翻盖精品盒 Rigid Box）", "左二（抽屉盒 Drawer Box）", "左三（折叠卡盒 Folding Box）", "右一（木盒 Wooden Box）"], "answer": 2, "image": ["img_006.jpg"], "hint": "折叠卡盒(img_006)可折叠平铺，节省运输空间，成本最低，适合大批量零售。"},
  {"id": "v6q212", "num": 212, "type": "single", "chapter": 10, "section": "10.3 综合图片选择题", "textZh": "以下两图：左图为标准中套（B结构），右图为定制肩套（A结构）。以下哪种说法最准确？", "options": ["左图用于A结构，右图用于B结构", "左图（标准中套）用于B结构欧美风格，右图（肩套）用于A结构中东风格", "两款配件功能相同，只是颜色不同", "两款都是中套（Collar）"], "answer": 1, "image": ["img_032.jpg", "img_031.jpg"], "hint": "标准中套=B结构欧美风格；定制肩套=A结构中东风格。接单必须与客户确认结构！"},
